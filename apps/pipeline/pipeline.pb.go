...
type Status struct {
	...
	StageStatus []*StageStatus `protobuf:"bytes,1,rep,name=stage_status,json=stageStatus,proto3" json:"stage_status" bson:"stage_status"`
}
...
func (x *Status) GetStageStatus() []*StageStatus {
	if x != nil {
...
var file_apps_pipeline_pb_pipeline_proto_rawDesc = []byte{
	...
	0x22, 0x53, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x49, 0x0a, 0x0c, 0x73, 0x74,
	0x61, 0x67, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	...
	0x67, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x0b, 0x73, 0x74, 0x61, 0x67, 0x65, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x56, 0x0a, 0x0b, 0x53, 0x74, 0x61, 0x67, 0x65, 0x53, 0x74,
	...
	0x75, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61,
	0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x70, 0x61, 0x61, 0x73, 0x2e, 0x74, 0x61, 0x73, 0x6b,
	0x2e, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x2b, 0x5a,
...
var file_apps_pipeline_pb_pipeline_proto_goTypes = []interface{}{
	...
	(*Status)(nil),                // 4: infraboard.mpaas.pipeline.Status
	(*StageStatus)(nil),           // 5: infraboard.mpaas.pipeline.StageStatus
	nil,                           // 6: infraboard.mpaas.pipeline.CreatePipelineRequest.LabelsEntry
	(*job.RunParam)(nil),          // 7: infraboard.mpaas.job.RunParam
	(*task.RunJobRequest)(nil),    // 8: infraboard.mpaas.task.RunJobRequest
	(*task.Task)(nil),             // 9: infraboard.mpaas.task.Task
}
var file_apps_pipeline_pb_pipeline_proto_depIdxs = []int32{
	...
	4, // 2: infraboard.mpaas.pipeline.Pipeline.status:type_name -> infraboard.mpaas.pipeline.Status
	3, // 3: infraboard.mpaas.pipeline.CreatePipelineRequest.stages:type_name -> infraboard.mpaas.pipeline.Stage
	6, // 4: infraboard.mpaas.pipeline.CreatePipelineRequest.labels:type_name -> infraboard.mpaas.pipeline.CreatePipelineRequest.LabelsEntry
	7, // 5: infraboard.mpaas.pipeline.Stage.with:type_name -> infraboard.mpaas.job.RunParam
	8, // 6: infraboard.mpaas.pipeline.Stage.tasks:type_name -> infraboard.mpaas.task.RunJobRequest
	5, // 7: infraboard.mpaas.pipeline.Status.stage_status:type_name -> infraboard.mpaas.pipeline.StageStatus
	9, // 8: infraboard.mpaas.pipeline.StageStatus.status:type_name -> infraboard.mpaas.task.Task
