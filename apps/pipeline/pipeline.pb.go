...
var file_mpaas_apps_pipeline_pb_pipeline_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x6a, 0x6f, 0x62, 0x73, 0x22, 0xe4, 0x06, 0x0a, 0x0d, 0x52, 0x75, 0x6e, 0x4a, 0x6f,
	...
	,
...
var file_mpaas_apps_pipeline_pb_pipeline_proto_goTypes = []interface{}{
	...
	(resource.VISIABLE)(0),        // 14: infraboard.mcube.resource.VISIABLE
	(*job.RunParam)(nil),          // 15: infraboard.mpaas.job.RunParam
	(job.RUN_MODE)(0),             // 16: infraboard.mpaas.job.RUN_MODE
	(*job.RunParamSet)(nil),       // 17: infraboard.mpaas.job.RunParamSet
	(notify.NOTIFY_TYPE)(0),       // 18: infraboard.mcenter.notify.NOTIFY_TYPE
}
var file_mpaas_apps_pipeline_pb_pipeline_proto_depIdxs = []int32{
	...
	14, // 3: infraboard.mpaas.pipeline.CreatePipelineRequest.visiable_mode:type_name -> infraboard.mcube.resource.VISIABLE
	15, // 4: infraboard.mpaas.pipeline.CreatePipelineRequest.with:type_name -> infraboard.mpaas.job.RunParam
	...
	15, // 9: infraboard.mpaas.pipeline.Stage.with:type_name -> infraboard.mpaas.job.RunParam
	5,  // 10: infraboard.mpaas.pipeline.Stage.jobs:type_name -> infraboard.mpaas.pipeline.RunJobRequest
	16, // 11: infraboard.mpaas.pipeline.RunJobRequest.run_mode:type_name -> infraboard.mpaas.job.RUN_MODE
	17, // 12: infraboard.mpaas.pipeline.RunJobRequest.run_params:type_name -> infraboard.mpaas.job.RunParamSet
	17, // 13: infraboard.mpaas.pipeline.RunJobRequest.rollback_params:type_name -> infraboard.mpaas.job.RunParamSet
	...
	10, // 16: infraboard.mpaas.pipeline.RunJobRequest.labels:type_name -> infraboard.mpaas.pipeline.RunJobRequest.LabelsEntry
	18, // 17: infraboard.mpaas.pipeline.MentionUser.notify_types:type_name -> infraboard.mcenter.notify.NOTIFY_TYPE
	16, // 18: infraboard.mpaas.pipeline.RunPipelineRequest.run_mode:type_name -> infraboard.mpaas.job.RUN_MODE
	0,  // 19: infraboard.mpaas.pipeline.RunPipelineRequest.trigger_mode:type_name -> infraboard.mpaas.pipeline.TRIGGER_MODE
	15, // 20: infraboard.mpaas.pipeline.RunPipelineRequest.run_params:type_name -> infraboard.mpaas.job.RunParam
	11, // 21: infraboard.mpaas.pipeline.RunPipelineRequest.labels:type_name -> infraboard.mpaas.pipeline.RunPipelineRequest.LabelsEntry
	12, // 22: infraboard.mpaas.pipeline.WebHook.header:type_name -> infraboard.mpaas.pipeline.WebHook.HeaderEntry
