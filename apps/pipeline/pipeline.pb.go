...
var file_mpaas_apps_pipeline_pb_pipeline_proto_rawDesc = []byte{
	...
	0x70, 0x61, 0x61, 0x73, 0x2e, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x2e, 0x4d, 0x65,
	...
	0x6d, 0x70, 0x61, 0x61, 0x73, 0x2e, 0x6a, 0x6f, 0x62, 0x2e, 0x52, 0x55, 0x4e, 0x5f, 0x4d, 0x4f,
	...
	0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x70, 0x61, 0x61,
	0x73, 0x2e, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x2e, 0x54, 0x52, 0x49, 0x47, 0x47,
	...
	0x72, 0x64, 0x2f, 0x6d, 0x70, 0x61, 0x61, 0x73, 0x2f, 0x61, 0x70, 0x70, 0x73, 0x2f, 0x70, 0x69,
...
var file_mpaas_apps_pipeline_pb_pipeline_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_mpaas_apps_pipeline_pb_pipeline_proto_goTypes = []interface{}{
	...
	nil,                           // 10: infraboard.mpaas.pipeline.RunJobRequest.ExtensionEntry
	nil,                           // 11: infraboard.mpaas.pipeline.RunJobRequest.LabelsEntry
	nil,                           // 12: infraboard.mpaas.pipeline.RunPipelineRequest.LabelsEntry
	nil,                           // 13: infraboard.mpaas.pipeline.WebHook.HeaderEntry
	(*resource.Meta)(nil),         // 14: infraboard.mcube.resource.Meta
	(resource.VISIABLE)(0),        // 15: infraboard.mcube.resource.VISIABLE
	(*job.RunParam)(nil),          // 16: infraboard.mpaas.job.RunParam
	(job.RUN_MODE)(0),             // 17: infraboard.mpaas.job.RUN_MODE
	(*job.RunParamSet)(nil),       // 18: infraboard.mpaas.job.RunParamSet
...
var file_mpaas_apps_pipeline_pb_pipeline_proto_depIdxs = []int32{
	...
	14, // 1: infraboard.mpaas.pipeline.Pipeline.meta:type_name -> infraboard.mcube.resource.Meta
	3,  // 2: infraboard.mpaas.pipeline.Pipeline.spec:type_name -> infraboard.mpaas.pipeline.CreatePipelineRequest
	15, // 3: infraboard.mpaas.pipeline.CreatePipelineRequest.visiable_mode:type_name -> infraboard.mcube.resource.VISIABLE
	16, // 4: infraboard.mpaas.pipeline.CreatePipelineRequest.with:type_name -> infraboard.mpaas.job.RunParam
	4,  // 5: infraboard.mpaas.pipeline.CreatePipelineRequest.stages:type_name -> infraboard.mpaas.pipeline.Stage
	8,  // 6: infraboard.mpaas.pipeline.CreatePipelineRequest.webhooks:type_name -> infraboard.mpaas.pipeline.WebHook
	6,  // 7: infraboard.mpaas.pipeline.CreatePipelineRequest.mention_users:type_name -> infraboard.mpaas.pipeline.MentionUser
	9,  // 8: infraboard.mpaas.pipeline.CreatePipelineRequest.labels:type_name -> infraboard.mpaas.pipeline.CreatePipelineRequest.LabelsEntry
	16, // 9: infraboard.mpaas.pipeline.Stage.with:type_name -> infraboard.mpaas.job.RunParam
	5,  // 10: infraboard.mpaas.pipeline.Stage.jobs:type_name -> infraboard.mpaas.pipeline.RunJobRequest
	17, // 11: infraboard.mpaas.pipeline.RunJobRequest.run_mode:type_name -> infraboard.mpaas.job.RUN_MODE
	18, // 12: infraboard.mpaas.pipeline.RunJobRequest.run_params:type_name -> infraboard.mpaas.job.RunParamSet
	18, // 13: infraboard.mpaas.pipeline.RunJobRequest.rollback_params:type_name -> infraboard.mpaas.job.RunParamSet
	8,  // 14: infraboard.mpaas.pipeline.RunJobRequest.webhooks:type_name -> infraboard.mpaas.pipeline.WebHook
	6,  // 15: infraboard.mpaas.pipeline.RunJobRequest.mention_users:type_name -> infraboard.mpaas.pipeline.MentionUser
	10, // 16: infraboard.mpaas.pipeline.RunJobRequest.extension:type_name -> infraboard.mpaas.pipeline.RunJobRequest.ExtensionEntry
	11, // 17: infraboard.mpaas.pipeline.RunJobRequest.labels:type_name -> infraboard.mpaas.pipeline.RunJobRequest.LabelsEntry
	19, // 18: infraboard.mpaas.pipeline.MentionUser.notify_types:type_name -> infraboard.mcenter.notify.NOTIFY_TYPE
	17, // 19: infraboard.mpaas.pipeline.RunPipelineRequest.run_mode:type_name -> infraboard.mpaas.job.RUN_MODE
	0,  // 20: infraboard.mpaas.pipeline.RunPipelineRequest.trigger_mode:type_name -> infraboard.mpaas.pipeline.TRIGGER_MODE
	16, // 21: infraboard.mpaas.pipeline.RunPipelineRequest.run_params:type_name -> infraboard.mpaas.job.RunParam
	12, // 22: infraboard.mpaas.pipeline.RunPipelineRequest.labels:type_name -> infraboard.mpaas.pipeline.RunPipelineRequest.LabelsEntry
	13, // 23: infraboard.mpaas.pipeline.WebHook.header:type_name -> infraboard.mpaas.pipeline.WebHook.HeaderEntry
