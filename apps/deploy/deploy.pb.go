...
const (
	...
	// 版本升级中, 发布新版本时触发
	STAGE_UPGRADING STAGE = 2
	// 升级规模, 副本增加时触发
	STAGE_SCALE_UP STAGE = 4
	// 版本降级中, 回滚时触发
	STAGE_DOWNGRADING STAGE = 3
	// 降级规模, 副本缩减时触发
	STAGE_SCAL_DOWN STAGE = 5
	// 正常运行
	STAGE_ACTIVE STAGE = 6
	// 有风险,但是服务正常使用
	STAGE_WARNNING STAGE = 8
	// 异常运行
	STAGE_ERROR STAGE = 10
	// 已停止, 副本数调整为0时触发
...
var file_apps_deploy_pb_deploy_proto_rawDesc = []byte{
	...
	0x6f, 0x73, 0x74, 0x54, 0x79, 0x70, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0xdf, 0x05,
	...
	0x28, 0x08, 0x52, 0x0a, 0x69, 0x73, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x61, 0x6c, 0x12, 0x54,
	...
	,
	...
	0x48, 0x4f, 0x53, 0x54, 0x10, 0x01, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_apps_deploy_pb_deploy_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_apps_deploy_pb_deploy_proto_goTypes = []interface{}{
	...
	(*Credential)(nil),              // 5: infraboard.mpaas.deploy.Credential
	(*K8STypeConfig)(nil),           // 6: infraboard.mpaas.deploy.K8sTypeConfig
	(*HostTypeConfig)(nil),          // 7: infraboard.mpaas.deploy.HostTypeConfig
	(*CreateDeploymentRequest)(nil), // 8: infraboard.mpaas.deploy.CreateDeploymentRequest
	nil,                             // 9: infraboard.mpaas.deploy.CreateDeploymentRequest.LabelsEntry
	(*meta.Meta)(nil),               // 10: infraboard.mpaas.common.meta.Meta
	(*meta.Scope)(nil),              // 11: infraboard.mpaas.common.meta.Scope
}
var file_apps_deploy_pb_deploy_proto_depIdxs = []int32{
	...
	10, // 1: infraboard.mpaas.deploy.Deployment.meta:type_name -> infraboard.mpaas.common.meta.Meta
	11, // 2: infraboard.mpaas.deploy.Deployment.scope:type_name -> infraboard.mpaas.common.meta.Scope
	8,  // 3: infraboard.mpaas.deploy.Deployment.spec:type_name -> infraboard.mpaas.deploy.CreateDeploymentRequest
	5,  // 4: infraboard.mpaas.deploy.Deployment.credential:type_name -> infraboard.mpaas.deploy.Credential
	4,  // 5: infraboard.mpaas.deploy.Deployment.status:type_name -> infraboard.mpaas.deploy.Status
	...
	6,  // 8: infraboard.mpaas.deploy.CreateDeploymentRequest.k8s_type_config:type_name -> infraboard.mpaas.deploy.K8sTypeConfig
	7,  // 9: infraboard.mpaas.deploy.CreateDeploymentRequest.host_type_config:type_name -> infraboard.mpaas.deploy.HostTypeConfig
	9,  // 10: infraboard.mpaas.deploy.CreateDeploymentRequest.labels:type_name -> infraboard.mpaas.deploy.CreateDeploymentRequest.LabelsEntry
