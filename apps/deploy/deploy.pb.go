...
type CreateDeploymentRequest struct {
	...
	InternalAccess *Access `protobuf:"bytes,16,opt,name=internal_access,json=internalAccess,proto3" json:"internal_access" bson:"internal_access"`
	// 外部访问地址
	// @gotags: bson:"public_access" json:"public_access"
	PublicAccess *Access `protobuf:"bytes,17,opt,name=public_access,json=publicAccess,proto3" json:"public_access" bson:"public_access"`
	// 部署标签
...
func (x *CreateDeploymentRequest) GetInternalAccess() *Access {
	if x != nil {
...
func (x *CreateDeploymentRequest) GetPublicAccess() *Access {
	if x != nil {
...
type Access struct {
	...
	Services []*ServiceInfo `protobuf:"bytes,2,rep,name=services,proto3" json:"host" bson:"host"`
}
...
func (x *Access) GetType() ACCESS_TYPE {
	if x != nil {
		return x.Type
	}
...
func (x *Access) GetServices() []*ServiceInfo {
	if x != nil {
		return x.Services
	}
	return nil
...
var file_apps_deploy_pb_deploy_proto_rawDesc = []byte{
	...
	0x6f, 0x73, 0x74, 0x54, 0x79, 0x70, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0xef, 0x06,
	...
	0x28, 0x08, 0x52, 0x0a, 0x69, 0x73, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x61, 0x6c, 0x12, 0x48,
	0x0a, 0x0f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x5f, 0x61, 0x63, 0x63, 0x65, 0x73,
	0x73, 0x18, 0x10, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62,
	0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x70, 0x61, 0x61, 0x73, 0x2e, 0x64, 0x65, 0x70, 0x6c, 0x6f,
	0x79, 0x2e, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x52, 0x0e, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e,
	0x61, 0x6c, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x12, 0x44, 0x0a, 0x0d, 0x70, 0x75, 0x62, 0x6c,
	...
	0x52, 0x0c, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x12, 0x54,
	0x0a, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x18, 0x19, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3c,
	...
	0x84, 0x01, 0x0a, 0x06, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x12, 0x38, 0x0a, 0x04, 0x74, 0x79,
	...
	0x74, 0x79, 0x70, 0x65, 0x12, 0x40, 0x0a, 0x08, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f,
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x22, 0x35, 0x0a, 0x0b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x2a, 0xa2, 0x01,
	...
	0x53, 0x54, 0x10, 0x01, 0x2a, 0x16, 0x0a, 0x0b, 0x41, 0x43, 0x43, 0x45, 0x53, 0x53, 0x5f, 0x54,
...
var file_apps_deploy_pb_deploy_proto_goTypes = []interface{}{
	...
	(*Access)(nil),                  // 10: infraboard.mpaas.deploy.Access
	(*ServiceInfo)(nil),             // 11: infraboard.mpaas.deploy.ServiceInfo
...
var file_apps_deploy_pb_deploy_proto_depIdxs = []int32{
	...
	10, // 10: infraboard.mpaas.deploy.CreateDeploymentRequest.internal_access:type_name -> infraboard.mpaas.deploy.Access
	10, // 11: infraboard.mpaas.deploy.CreateDeploymentRequest.public_access:type_name -> infraboard.mpaas.deploy.Access
	...
	2,  // 13: infraboard.mpaas.deploy.Access.type:type_name -> infraboard.mpaas.deploy.ACCESS_TYPE
	11, // 14: infraboard.mpaas.deploy.Access.services:type_name -> infraboard.mpaas.deploy.ServiceInfo
