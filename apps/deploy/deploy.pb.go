...
type AccessAddress struct {
	...
	// 访问地址
	// @gotags: bson:"service_env" json:"service_env"
	ServiceEnv []*ServiceEnv `protobuf:"bytes,2,rep,name=service_env,json=serviceEnv,proto3" json:"service_env" bson:"service_env"`
}
...
func (x *AccessAddress) GetServiceEnv() []*ServiceEnv {
	if x != nil {
		return x.ServiceEnv
	}
	return nil
...
func (x *ServiceEnv) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ServiceEnv) GetExample() string {
	if x != nil {
		return x.Example
	}
	return ""
...
var file_apps_deploy_pb_deploy_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x8f, 0x01, 0x0a, 0x0d,
	...
	0x45, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x44, 0x0a, 0x0b, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x5f, 0x65, 0x6e, 0x76, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x69,
	0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x70, 0x61, 0x61, 0x73, 0x2e,
	0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x45, 0x6e,
	0x76, 0x52, 0x0a, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x45, 0x6e, 0x76, 0x22, 0x3a, 0x0a,
	0x0a, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x45, 0x6e, 0x76, 0x12, 0x12, 0x0a, 0x04, 0x6e,
...
var file_apps_deploy_pb_deploy_proto_goTypes = []interface{}{
	...
	(*ServiceEnv)(nil),              // 12: infraboard.mpaas.deploy.ServiceEnv
...
var file_apps_deploy_pb_deploy_proto_depIdxs = []int32{
	...
	12, // 14: infraboard.mpaas.deploy.AccessAddress.service_env:type_name -> infraboard.mpaas.deploy.ServiceEnv
