...
type CreateDeploymentRequest struct {
	...
	// 是否开启集群事件通知
	// @gotags: bson:"enable_event_notify" json:"enable_event_notify"
	EnableEventNotify bool `protobuf:"varint,26,opt,name=enable_event_notify,json=enableEventNotify,proto3" json:"enable_event_notify" bson:"enable_event_notify"`
	// 需要通知的事件等级
	// @gotags: bson:"notify_level" json:"notify_level"
	NotifyLevel event.LEVEL `protobuf:"varint,27,opt,name=notify_level,json=notifyLevel,proto3,enum=infraboard.mpaas.event.LEVEL" json:"notify_level" bson:"notify_level"`
	// 部署有异常事件时需要被通知的人
	// @gotags: bson:"notify_users" json:"notify_users"
	NotifyUsers []string `protobuf:"bytes,24,rep,name=notify_users,json=notifyUsers,proto3" json:"notify_users" bson:"notify_users"`
	// 是否是模版
...
func (x *CreateDeploymentRequest) GetEnableEventNotify() bool {
	if x != nil {
		return x.EnableEventNotify
	}
	return false
}

func (x *CreateDeploymentRequest) GetNotifyLevel() event.LEVEL {
	if x != nil {
		return x.NotifyLevel
	}
	return event.LEVEL(0)
}

func (x *CreateDeploymentRequest) GetNotifyUsers() []string {
	if x != nil {
...
var file_mpaas_apps_deploy_pb_deploy_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x54, 0x79, 0x70, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0xca, 0x08, 0x0a,
	...
	,
	...
	,
	...
	0x69, 0x63, 0x22, 0x8e, 0x01, 0x0a, 0x0d, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x41, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0x12, 0x38, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x24, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e,
	0x6d, 0x70, 0x61, 0x61, 0x73, 0x2e, 0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x2e, 0x41, 0x43, 0x43,
	0x45, 0x53, 0x53, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x43,
	0x0a, 0x0b, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x65, 0x6e, 0x76, 0x73, 0x18, 0x02, 0x20,
	...
	,
...
var file_mpaas_apps_deploy_pb_deploy_proto_goTypes = []interface{}{
	...
	(event.LEVEL)(0),                // 22: infraboard.mpaas.event.LEVEL
}
var file_mpaas_apps_deploy_pb_deploy_proto_depIdxs = []int32{
	...
	22, // 13: infraboard.mpaas.deploy.CreateDeploymentRequest.notify_level:type_name -> infraboard.mpaas.event.LEVEL
	...
	20, // 18: infraboard.mpaas.deploy.CreateDeploymentRequest.labels:type_name -> infraboard.mpaas.deploy.CreateDeploymentRequest.LabelsEntry
	17, // 19: infraboard.mpaas.deploy.AccessInfo.private:type_name -> infraboard.mpaas.deploy.AccessAddress
	17, // 20: infraboard.mpaas.deploy.AccessInfo.public:type_name -> infraboard.mpaas.deploy.AccessAddress
	3,  // 21: infraboard.mpaas.deploy.AccessAddress.type:type_name -> infraboard.mpaas.deploy.ACCESS_TYPE
	18, // 22: infraboard.mpaas.deploy.AccessAddress.access_envs:type_name -> infraboard.mpaas.deploy.AccessEnv
