...
type CreateDeploymentRequest struct {
	...
	Environment string `protobuf:"bytes,5,opt,name=environment,proto3" json:"environment" bson:"environment" validate:"required"`
	// 部署资源提供方
	// @gotags: bson:"provider" json:"provider" validate:"required"
	Provider string `protobuf:"bytes,6,opt,name=provider,proto3" json:"provider" bson:"provider" validate:"required"`
	// 部署地域
	// @gotags: bson:"region" json:"region" validate:"required"
	Region string `protobuf:"bytes,7,opt,name=region,proto3" json:"region" bson:"region" validate:"required"`
	// 部署方式
	// @gotags: bson:"type" json:"type"
	Type TYPE `protobuf:"varint,8,opt,name=type,proto3,enum=infraboard.mpaas.deploy.TYPE" json:"type" bson:"type"`
	// 集群的配置是否需要认证才能访问, 开启后会生成一个Token
	// @gotags: bson:"auth_enabled" json:"auth_enabled"
	AuthEnabled bool `protobuf:"varint,9,opt,name=auth_enabled,json=authEnabled,proto3" json:"auth_enabled" bson:"auth_enabled"`
	// k8s模式下的部署配置
	// @gotags: json:"k8s_type_config" bson:"k8s_type_config"
	K8STypeConfig *K8STypeConfig `protobuf:"bytes,10,opt,name=k8s_type_config,json=k8sTypeConfig,proto3" json:"k8s_type_config" bson:"k8s_type_config"`
	// 主机部署相关配置
	// @gotags: json:"host_type_config" bson:"host_type_config"
	HostTypeConfig *HostTypeConfig `protobuf:"bytes,11,opt,name=host_type_config,json=hostTypeConfig,proto3" json:"host_type_config" bson:"host_type_config"`
	// 部署描述信息
	// @gotags: bson:"describe" json:"describe"
	Describe string `protobuf:"bytes,12,opt,name=describe,proto3" json:"describe" bson:"describe"`
	// 部署Id, 没有系统会自动生成
	...
	IsApproval bool `protobuf:"varint,14,opt,name=is_approval,json=isApproval,proto3" json:"is_approval" bson:"is_approval"`
	// 部署标签
...
var file_apps_deploy_pb_deploy_proto_rawDesc = []byte{
	...
	0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0xb6, 0x05, 0x0a, 0x17, 0x43, 0x72, 0x65, 0x61,
	...
	0x74, 0x79, 0x70, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x69, 0x6e, 0x66,
	...
	0x09, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x61, 0x75, 0x74, 0x68, 0x45, 0x6e, 0x61, 0x62, 0x6c,
	0x65, 0x64, 0x12, 0x4e, 0x0a, 0x0f, 0x6b, 0x38, 0x73, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x5f, 0x63,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x69, 0x6e,
	...
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x69,
	0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x70, 0x61, 0x61, 0x73, 0x2e,
	...
	0x65, 0x12, 0x1b, 0x0a, 0x09, 0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x0d,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x49, 0x64, 0x12, 0x1f,
	0x0a, 0x0b, 0x69, 0x73, 0x5f, 0x61, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x61, 0x6c, 0x18, 0x0e, 0x20,
