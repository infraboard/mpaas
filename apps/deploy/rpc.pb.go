...
type UpdateDeploymentStatusRequest struct {
	...
	K8SUpdateDetail *K8SUpdateDetail `protobuf:"bytes,5,opt,name=k8s_update_detail,json=k8sUpdateDetail,proto3" json:"k8s_update_detail"`
}
...
func (x *UpdateDeploymentStatusRequest) GetStatus() *Status {
	if x != nil {
		return x.Status
	}
	return nil
...
func (x *UpdateDeploymentStatusRequest) GetK8SUpdateDetail() *K8SUpdateDetail {
	if x != nil {
		return x.K8SUpdateDetail
	}
	return nil
}

// 实时更新k8s相关配置
type K8SUpdateDetail struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	WorkloadConfig string `protobuf:"bytes,1,opt,name=workload_config,json=workloadConfig,proto3" json:"workload_config" bson:"workload_config" validate:"required"`
	// k8s service配置
	// @gotags: bson:"service" json:"service"
	Service string `protobuf:"bytes,2,opt,name=service,proto3" json:"service" bson:"service"`
}

func (x *K8SUpdateDetail) Reset() {
	*x = K8SUpdateDetail{}
	if protoimpl.UnsafeEnabled {
...
func (x *K8SUpdateDetail) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*K8SUpdateDetail) ProtoMessage() {}

func (x *K8SUpdateDetail) ProtoReflect() protoreflect.Message {
	mi := &file_apps_deploy_pb_rpc_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use K8SUpdateDetail.ProtoReflect.Descriptor instead.
func (*K8SUpdateDetail) Descriptor() ([]byte, []int) {
	return file_apps_deploy_pb_rpc_proto_rawDescGZIP(), []int{1}
}

func (x *K8SUpdateDetail) GetWorkloadConfig() string {
	if x != nil {
...
func (x *K8SUpdateDetail) GetService() string {
	if x != nil {
		return x.Service
	}
	return ""
...
func (x *DeleteDeploymentRequest) Reset() {
	*x = DeleteDeploymentRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_apps_deploy_pb_rpc_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteDeploymentRequest) Descriptor() ([]byte, []int) {
	return file_apps_deploy_pb_rpc_proto_rawDescGZIP(), []int{5}
}
...
var file_apps_deploy_pb_rpc_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xfe, 0x01, 0x0a, 0x1d, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x79, 0x12, 0x37, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74,
	...
	,
	...
	0x73, 0x22, 0x89, 0x01, 0x0a, 0x19, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x44, 0x65,
	...
	0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0xd3, 0x01,
	0x0a, 0x17, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65,
	0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x45, 0x0a, 0x0b, 0x75, 0x70, 0x64,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x79, 0x12, 0x44, 0x0a,
	0x04, 0x73, 0x70, 0x65, 0x63, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x69, 0x6e,
	...
	0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x04, 0x73,
	0x70, 0x65, 0x63, 0x22, 0x29, 0x0a, 0x17, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x44, 0x65, 0x70,
	0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e,
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x2a, 0x15,
	0x0a, 0x0b, 0x44, 0x45, 0x53, 0x43, 0x52, 0x49, 0x42, 0x45, 0x5f, 0x42, 0x59, 0x12, 0x06, 0x0a,
	0x02, 0x49, 0x44, 0x10, 0x00, 0x32, 0xd7, 0x02, 0x0a, 0x03, 0x52, 0x50, 0x43, 0x12, 0x6a, 0x0a,
	...
	0x70, 0x6c, 0x6f, 0x79, 0x2e, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x42,
...
var file_apps_deploy_pb_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_apps_deploy_pb_rpc_proto_goTypes = []interface{}{
	...
	(*K8SUpdateDetail)(nil),               // 2: infraboard.mpaas.deploy.K8sUpdateDetail
	...
	(*Status)(nil),                        // 7: infraboard.mpaas.deploy.Status
...
var file_apps_deploy_pb_rpc_proto_depIdxs = []int32{
	7,  // 0: infraboard.mpaas.deploy.UpdateDeploymentStatusRequest.status:type_name -> infraboard.mpaas.deploy.Status
	2,  // 1: infraboard.mpaas.deploy.UpdateDeploymentStatusRequest.k8s_update_detail:type_name -> infraboard.mpaas.deploy.K8sUpdateDetail
	8,  // 2: infraboard.mpaas.deploy.QueryDeploymentRequest.page:type_name -> infraboard.mcube.page.PageRequest
	0,  // 3: infraboard.mpaas.deploy.DescribeDeploymentRequest.describe_by:type_name -> infraboard.mpaas.deploy.DESCRIBE_BY
	9,  // 4: infraboard.mpaas.deploy.UpdateDeploymentRequest.update_mode:type_name -> infraboard.mcube.request.UpdateMode
	10, // 5: infraboard.mpaas.deploy.UpdateDeploymentRequest.spec:type_name -> infraboard.mpaas.deploy.CreateDeploymentRequest
	3,  // 6: infraboard.mpaas.deploy.RPC.QueryDeployment:input_type -> infraboard.mpaas.deploy.QueryDeploymentRequest
	4,  // 7: infraboard.mpaas.deploy.RPC.DescribeDeployment:input_type -> infraboard.mpaas.deploy.DescribeDeploymentRequest
	1,  // 8: infraboard.mpaas.deploy.RPC.UpdateDeploymentStatus:input_type -> infraboard.mpaas.deploy.UpdateDeploymentStatusRequest
...
func file_apps_deploy_pb_rpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_apps_deploy_pb_rpc_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
