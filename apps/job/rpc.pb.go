...
var file_apps_job_pb_rpc_proto_rawDesc = []byte{
	...
	0x62, 0x6c, 0x65, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x32, 0xa6, 0x01, 0x0a, 0x03, 0x52, 0x50, 0x43,
...
var file_apps_job_pb_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_apps_job_pb_rpc_proto_goTypes = []interface{}{
	(*QueryJobRequest)(nil),     // 0: infraboard.mpaas.job.QueryJobRequest
	(*request.PageRequest)(nil), // 1: infraboard.mcube.page.PageRequest
	(resource.VISIABLE_MODE)(0), // 2: infraboard.mcube.resource.VISIABLE_MODE
...
var file_apps_job_pb_rpc_proto_depIdxs = []int32{
	1, // 0: infraboard.mpaas.job.QueryJobRequest.page:type_name -> infraboard.mcube.page.PageRequest
	2, // 1: infraboard.mpaas.job.QueryJobRequest.visiable_mode:type_name -> infraboard.mcube.resource.VISIABLE_MODE
	3, // 2: infraboard.mpaas.job.RPC.CreateJob:input_type -> infraboard.mpaas.job.CreateJobRequest
	0, // 3: infraboard.mpaas.job.RPC.QueryJob:input_type -> infraboard.mpaas.job.QueryJobRequest
	4, // 4: infraboard.mpaas.job.RPC.CreateJob:output_type -> infraboard.mpaas.job.Job
	5, // 5: infraboard.mpaas.job.RPC.QueryJob:output_type -> infraboard.mpaas.job.JobSet
