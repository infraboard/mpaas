...
type QueryJobRequest struct {
	...
	// 是否查询公开Job
	// @gotags: json:"with_global"
	WithGlobal bool `protobuf:"varint,3,opt,name=with_global,json=withGlobal,proto3" json:"with_global"`
	// job Id列表
	// @gotags: json:"ids"
...
func (x *QueryJobRequest) GetWithGlobal() bool {
	if x != nil {
		return x.WithGlobal
	}
	return false
...
var file_apps_job_pb_rpc_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xaa, 0x01, 0x0a, 0x0f, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4a, 0x6f,
	0x62, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x36, 0x0a, 0x04, 0x70, 0x61, 0x67, 0x65,
	...
	0x52, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x12, 0x1f, 0x0a, 0x0b, 0x77, 0x69, 0x74, 0x68,
	0x5f, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x77,
	0x69, 0x74, 0x68, 0x47, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x64, 0x73,
	0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x03, 0x69, 0x64, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x6e,
	0x61, 0x6d, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x6e, 0x61, 0x6d, 0x65,
	0x73, 0x32, 0xa6, 0x01, 0x0a, 0x03, 0x52, 0x50, 0x43, 0x12, 0x4e, 0x0a, 0x09, 0x43, 0x72, 0x65,
	...
	0x6a, 0x6f, 0x62, 0x2e, 0x4a, 0x6f, 0x62, 0x53, 0x65, 0x74, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69,
...
var file_apps_job_pb_rpc_proto_depIdxs = []int32{
	...
	2, // 1: infraboard.mpaas.job.RPC.CreateJob:input_type -> infraboard.mpaas.job.CreateJobRequest
	0, // 2: infraboard.mpaas.job.RPC.QueryJob:input_type -> infraboard.mpaas.job.QueryJobRequest
	3, // 3: infraboard.mpaas.job.RPC.CreateJob:output_type -> infraboard.mpaas.job.Job
	4, // 4: infraboard.mpaas.job.RPC.QueryJob:output_type -> infraboard.mpaas.job.JobSet
