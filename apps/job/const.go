...
const (
	...
	// Git 项目相关变量
	// Git 项目代码仓库
	SYSTEM_VARIABLE_GIT_REPOSITORY = "GIT_REPOSITORY"
	// Git 项目分支
	SYSTEM_VARIABLE_GIT_BRANCH = "GIT_BRANCH"
	// Git 项目Tag
	SYSTEM_VARIABLE_GIT_TAG = "GIT_TAG"
	// Git 项目Commit号
	SYSTEM_VARIABLE_GIT_COMMIT_ID = "GIT_COMMIT_ID"
)
