...
type CreateJobRequest struct {
	...
	RunParams []*VersionedRunParamDesc `protobuf:"bytes,10,rep,name=run_params,json=runParams,proto3" json:"run_params" bson:"run_params"`
	// 标签
...
type VersionedRunParamDesc struct {
	...
	// 运行时 用户传人的参数说明
	// @gotags: bson:"run_params" json:"run_params"
	RunParams []*RunParam `protobuf:"bytes,3,rep,name=run_params,json=runParams,proto3" json:"run_params" bson:"run_params"`
}
...
func (x *VersionedRunParamDesc) GetRunParams() []*RunParam {
	if x != nil {
		return x.RunParams
	}
	return nil
...
var file_apps_job_pb_job_proto_rawDesc = []byte{
	...
	0x22, 0xd9, 0x04, 0x0a, 0x10, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4a, 0x6f, 0x62, 0x52, 0x65,
	...
	0x62, 0x6c, 0x65, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x4a, 0x0a, 0x0a, 0x72, 0x75, 0x6e, 0x5f, 0x70,
	0x61, 0x72, 0x61, 0x6d, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x69, 0x6e,
	...
	0x61, 0x6d, 0x73, 0x12, 0x4a, 0x0a, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x18, 0x0b, 0x20,
	...
	0x6f, 0x6e, 0x12, 0x3d, 0x0a, 0x0a, 0x72, 0x75, 0x6e, 0x5f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73,
	...
	0x73, 0x22, 0x64, 0x0a, 0x08, 0x52, 0x75, 0x6e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x1a, 0x0a,
	0x08, 0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x08, 0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x2a, 0x1a, 0x0a, 0x0b, 0x52, 0x55, 0x4e, 0x4e, 0x45,
...
var file_apps_job_pb_job_proto_goTypes = []interface{}{
	...
	(*RunParam)(nil),              // 5: infraboard.mpaas.job.RunParam
...
var file_apps_job_pb_job_proto_depIdxs = []int32{
	...
	4, // 4: infraboard.mpaas.job.CreateJobRequest.run_params:type_name -> infraboard.mpaas.job.VersionedRunParamDesc
	6, // 5: infraboard.mpaas.job.CreateJobRequest.labels:type_name -> infraboard.mpaas.job.CreateJobRequest.LabelsEntry
	5, // 6: infraboard.mpaas.job.VersionedRunParamDesc.run_params:type_name -> infraboard.mpaas.job.RunParam
