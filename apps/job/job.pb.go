...
type CreateJobRequest struct {
	...
	// 运行时 用户传人的参数说明(不同版本有不同参数)
	// @gotags: bson:"run_params" json:"run_params"
	RollbackParams []*VersionedRunParam `protobuf:"bytes,5,rep,name=rollback_params,json=rollbackParams,proto3" json:"run_params" bson:"run_params"`
	// 所属域
	// @gotags: bson:"domain" json:"domain" validate:"required"
	Domain string `protobuf:"bytes,6,opt,name=domain,proto3" json:"domain" bson:"domain" validate:"required"`
	// 所属空间
	// @gotags: bson:"namespace" json:"namespace" validate:"required"
	Namespace string `protobuf:"bytes,7,opt,name=namespace,proto3" json:"namespace" bson:"namespace" validate:"required"`
	// 创建人
	// @gotags: bson:"create_by" json:"create_by" validate:"required"
	CreateBy string `protobuf:"bytes,8,opt,name=create_by,json=createBy,proto3" json:"create_by" bson:"create_by" validate:"required"`
	// 图片
	// @gotags: bson:"logo" json:"logo"
	Logo string `protobuf:"bytes,9,opt,name=logo,proto3" json:"logo" bson:"logo"`
	// 名称, 不能包含特殊字符(. , #)
	// @gotags: bson:"name" json:"name" validate:"required"
	Name string `protobuf:"bytes,10,opt,name=name,proto3" json:"name" bson:"name" validate:"required"`
	// 展示名称
	// @gotags: bson:"display_name" json:"display_name"
	DisplayName string `protobuf:"bytes,11,opt,name=display_name,json=displayName,proto3" json:"display_name" bson:"display_name"`
	// 是否是公开Job, 默认只能本空间内访问
	// @gotags: bson:"visiable_mode" json:"visiable_mode"
	VisiableMode resource.VISIABLE_MODE `protobuf:"varint,12,opt,name=visiable_mode,json=visiableMode,proto3,enum=infraboard.mcube.resource.VISIABLE_MODE" json:"visiable_mode" bson:"visiable_mode"`
	// 描述
...
var file_apps_job_pb_job_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x22, 0xd9, 0x05, 0x0a, 0x10, 0x43, 0x72, 0x65,
	...
	0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61,
	...
	0x79, 0x12, 0x12, 0x0a, 0x04, 0x6c, 0x6f, 0x67, 0x6f, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x04, 0x6c, 0x6f, 0x67, 0x6f, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x0a, 0x20,
	...
	0x76, 0x69, 0x73, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x0c, 0x20,
	...
	0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x32, 0x2e,
	...
	0x28, 0x09, 0x52, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x12, 0x50, 0x0a, 0x0a, 0x65, 0x78, 0x74,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xda, 0x03, 0x0a, 0x08, 0x52,
	0x75, 0x6e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x1a, 0x0a, 0x08, 0x72, 0x65, 0x71, 0x75, 0x69,
	0x72, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x72, 0x65, 0x71, 0x75, 0x69,
	0x72, 0x65, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x65, 0x73, 0x63, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x65, 0x73, 0x63, 0x12, 0x45, 0x0a, 0x0a, 0x76,
	...
	,
	...
	0x42, 0x10, 0x00, 0x2a, 0x42, 0x0a, 0x10, 0x50, 0x41, 0x52, 0x41, 0x4d, 0x5f, 0x56, 0x41, 0x4c,
	...
	0x5f, 0x45, 0x4e, 0x55, 0x4d, 0x10, 0x03, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_apps_job_pb_job_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_apps_job_pb_job_proto_goTypes = []interface{}{
	...
	(PARAM_VALUE_TYPE)(0),       // 1: infraboard.mpaas.job.PARAM_VALUE_TYPE
	(*K8SJobRunnerParams)(nil),  // 2: infraboard.mpaas.job.K8sJobRunnerParams
	(*JobSet)(nil),              // 3: infraboard.mpaas.job.JobSet
	(*Job)(nil),                 // 4: infraboard.mpaas.job.Job
	(*CreateJobRequest)(nil),    // 5: infraboard.mpaas.job.CreateJobRequest
	(*VersionedRunParam)(nil),   // 6: infraboard.mpaas.job.VersionedRunParam
	(*EnumOption)(nil),          // 7: infraboard.mpaas.job.EnumOption
	(*RunParam)(nil),            // 8: infraboard.mpaas.job.RunParam
	nil,                         // 9: infraboard.mpaas.job.CreateJobRequest.LabelsEntry
	nil,                         // 10: infraboard.mpaas.job.EnumOption.ExtensionsEntry
	nil,                         // 11: infraboard.mpaas.job.RunParam.ExtensionsEntry
	(*meta.Meta)(nil),           // 12: infraboard.mpaas.common.meta.Meta
	(resource.VISIABLE_MODE)(0), // 13: infraboard.mcube.resource.VISIABLE_MODE
}
var file_apps_job_pb_job_proto_depIdxs = []int32{
	4,  // 0: infraboard.mpaas.job.JobSet.items:type_name -> infraboard.mpaas.job.Job
	12, // 1: infraboard.mpaas.job.Job.meta:type_name -> infraboard.mpaas.common.meta.Meta
	5,  // 2: infraboard.mpaas.job.Job.spec:type_name -> infraboard.mpaas.job.CreateJobRequest
	0,  // 3: infraboard.mpaas.job.CreateJobRequest.runner_type:type_name -> infraboard.mpaas.job.RUNNER_TYPE
	6,  // 4: infraboard.mpaas.job.CreateJobRequest.run_params:type_name -> infraboard.mpaas.job.VersionedRunParam
	6,  // 5: infraboard.mpaas.job.CreateJobRequest.rollback_params:type_name -> infraboard.mpaas.job.VersionedRunParam
	13, // 6: infraboard.mpaas.job.CreateJobRequest.visiable_mode:type_name -> infraboard.mcube.resource.VISIABLE_MODE
	9,  // 7: infraboard.mpaas.job.CreateJobRequest.labels:type_name -> infraboard.mpaas.job.CreateJobRequest.LabelsEntry
	8,  // 8: infraboard.mpaas.job.VersionedRunParam.params:type_name -> infraboard.mpaas.job.RunParam
	10, // 9: infraboard.mpaas.job.EnumOption.extensions:type_name -> infraboard.mpaas.job.EnumOption.ExtensionsEntry
	1,  // 10: infraboard.mpaas.job.RunParam.value_type:type_name -> infraboard.mpaas.job.PARAM_VALUE_TYPE
	7,  // 11: infraboard.mpaas.job.RunParam.enum_options:type_name -> infraboard.mpaas.job.EnumOption
	11, // 12: infraboard.mpaas.job.RunParam.extensions:type_name -> infraboard.mpaas.job.RunParam.ExtensionsEntry
