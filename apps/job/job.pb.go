...
type CreateJobRequest struct {
	...
	ManualUpdateStatus bool `protobuf:"varint,3,opt,name=manual_update_status,json=manualUpdateStatus,proto3" json:"manual_update_status" bson:"manual_update_status"`
	// 运行时 用户传人的参数说明(不同版本有不同参数)
	// @gotags: bson:"run_params" json:"run_params"
	RunParams []*VersionedRunParam `protobuf:"bytes,4,rep,name=run_params,json=runParams,proto3" json:"run_params" bson:"run_params"`
	// 是否允许回滚, 有些特殊的操作是不允许回滚的,
	// 能使用上次执行成功的结果 进行执行 该任务就支持回滚
	// @gotags: bson:"allow_rollback" json:"allow_rollback"
	AllowRollback bool `protobuf:"varint,5,opt,name=allow_rollback,json=allowRollback,proto3" json:"allow_rollback" bson:"allow_rollback"`
	// 回滚参数, 当执行回滚时执行的参数, 往往由上次成功执行的参数进行填充
	// @gotags: bson:"rollback_params" json:"rollback_params"
	RollbackParams []*VersionedRunParam `protobuf:"bytes,6,rep,name=rollback_params,json=rollbackParams,proto3" json:"rollback_params" bson:"rollback_params"`
	// 所属域
	// @gotags: bson:"domain" json:"domain" validate:"required"
	Domain string `protobuf:"bytes,7,opt,name=domain,proto3" json:"domain" bson:"domain" validate:"required"`
	// 所属空间
	// @gotags: bson:"namespace" json:"namespace" validate:"required"
	Namespace string `protobuf:"bytes,8,opt,name=namespace,proto3" json:"namespace" bson:"namespace" validate:"required"`
	// 创建人
	// @gotags: bson:"create_by" json:"create_by" validate:"required"
	CreateBy string `protobuf:"bytes,9,opt,name=create_by,json=createBy,proto3" json:"create_by" bson:"create_by" validate:"required"`
	// 图片
	// @gotags: bson:"logo" json:"logo"
	Logo string `protobuf:"bytes,10,opt,name=logo,proto3" json:"logo" bson:"logo"`
	// 名称, 不能包含特殊字符(. , #)
	// @gotags: bson:"name" json:"name" validate:"required"
	Name string `protobuf:"bytes,11,opt,name=name,proto3" json:"name" bson:"name" validate:"required"`
	// 展示名称
	...
	VisiableMode resource.VISIABLE_MODE `protobuf:"varint,13,opt,name=visiable_mode,json=visiableMode,proto3,enum=infraboard.mcube.resource.VISIABLE_MODE" json:"visiable_mode" bson:"visiable_mode"`
	// 描述
	// @gotags: bson:"description" json:"description"
	Description string `protobuf:"bytes,14,opt,name=description,proto3" json:"description" bson:"description"`
	// 标签
...
type EnumOption struct {
	...
	Value string `protobuf:"bytes,1,opt,name=value,proto3" json:"value" bson:"value" validate:"required"`
	// 选项的说明
...
type RunParam struct {
	...
	ValueType PARAM_VALUE_TYPE `protobuf:"varint,4,opt,name=value_type,json=valueType,proto3,enum=infraboard.mpaas.job.PARAM_VALUE_TYPE" json:"value_type" bson:"value_type"`
	// 枚举值的选项
	// @gotags: bson:"enum_options" json:"enum_options,omitempty"
	EnumOptions []*EnumOption `protobuf:"bytes,5,rep,name=enum_options,json=enumOptions,proto3" json:"enum_options,omitempty" bson:"enum_options"`
	// 基于枚举的URL
	// @gotags: bson:"http_enum_url" json:"http_enum_url,omitempty"
	HttpEnumUrl string `protobuf:"bytes,6,opt,name=http_enum_url,json=httpEnumUrl,proto3" json:"http_enum_url,omitempty" bson:"http_enum_url"`
	// 值的样例
	// @gotags: bson:"example" json:"example"
	Example string `protobuf:"bytes,7,opt,name=example,proto3" json:"example" bson:"example"`
	...
	ReadOlny bool `protobuf:"varint,9,opt,name=read_olny,json=readOlny,proto3" json:"read_olny" bson:"read_olny"`
	// 扩展属性
	// @gotags: bson:"extensions" json:"extensions"
	Extensions map[string]string `protobuf:"bytes,15,rep,name=extensions,proto3" json:"extensions" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"extensions"`
}
...
func (x *RunParam) GetHttpEnumUrl() string {
	if x != nil {
		return x.HttpEnumUrl
	}
	return ""
}
...
func (x *RunParam) GetReadOlny() bool {
	if x != nil {
		return x.ReadOlny
	}
	return false
...
var file_apps_job_pb_job_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x22, 0x80, 0x06, 0x0a, 0x10, 0x43, 0x72, 0x65,
	...
	0x65, 0x63, 0x12, 0x30, 0x0a, 0x14, 0x6d, 0x61, 0x6e, 0x75, 0x61, 0x6c, 0x5f, 0x75, 0x70, 0x64,
	...
	0x61, 0x74, 0x75, 0x73, 0x12, 0x46, 0x0a, 0x0a, 0x72, 0x75, 0x6e, 0x5f, 0x70, 0x61, 0x72, 0x61,
	0x6d, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61,
	...
	0x6d, 0x52, 0x09, 0x72, 0x75, 0x6e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x25, 0x0a, 0x0e,
	0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x5f, 0x72, 0x6f, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x52, 0x6f, 0x6c, 0x6c, 0x62,
	0x61, 0x63, 0x6b, 0x12, 0x50, 0x0a, 0x0f, 0x72, 0x6f, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x5f,
	0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x69,
	...
	0x50, 0x61, 0x72, 0x61, 0x6d, 0x52, 0x0e, 0x72, 0x6f, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x50,
	0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x12, 0x1c, 0x0a,
	...
	0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6c, 0x6f, 0x67, 0x6f, 0x12, 0x12, 0x0a, 0x04,
	...
	0x61, 0x6d, 0x65, 0x12, 0x4d, 0x0a, 0x0d, 0x76, 0x69, 0x73, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x5f,
	0x6d, 0x6f, 0x64, 0x65, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x28, 0x2e, 0x69, 0x6e, 0x66,
	0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x63, 0x75, 0x62, 0x65, 0x2e, 0x72, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x56, 0x49, 0x53, 0x49, 0x41, 0x42, 0x4c, 0x45, 0x5f,
	0x4d, 0x4f, 0x44, 0x45, 0x52, 0x0c, 0x76, 0x69, 0x73, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x4d, 0x6f,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x4a, 0x0a, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x18, 0x0f,
	...
	0x64, 0x2e, 0x6d, 0x70, 0x61, 0x61, 0x73, 0x2e, 0x6a, 0x6f, 0x62, 0x2e, 0x45, 0x6e, 0x75, 0x6d,
	...
	0x01, 0x22, 0xda, 0x03, 0x0a, 0x08, 0x52, 0x75, 0x6e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x1a,
	0x0a, 0x08, 0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x08, 0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x26, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f,
	...
	0x6e, 0x52, 0x0b, 0x65, 0x6e, 0x75, 0x6d, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x22,
	0x0a, 0x0d, 0x68, 0x74, 0x74, 0x70, 0x5f, 0x65, 0x6e, 0x75, 0x6d, 0x5f, 0x75, 0x72, 0x6c, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x68, 0x74, 0x74, 0x70, 0x45, 0x6e, 0x75, 0x6d, 0x55,
	0x72, 0x6c, 0x12, 0x18, 0x0a, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x18, 0x07, 0x20,
	...
	0x75, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x72, 0x65, 0x61, 0x64, 0x5f, 0x6f, 0x6c, 0x6e, 0x79, 0x18,
	0x09, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x72, 0x65, 0x61, 0x64, 0x4f, 0x6c, 0x6e, 0x79, 0x12,
	...
	0x07, 0x4b, 0x38, 0x53, 0x5f, 0x4a, 0x4f, 0x42, 0x10, 0x00, 0x2a, 0x24, 0x0a, 0x08, 0x52, 0x55,
	...
	0x55, 0x4d, 0x10, 0x03, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2f, 0x6d, 0x70,
	0x61, 0x61, 0x73, 0x2f, 0x61, 0x70, 0x70, 0x73, 0x2f, 0x6a, 0x6f, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_apps_job_pb_job_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_apps_job_pb_job_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_apps_job_pb_job_proto_goTypes = []interface{}{
	...
	(*K8SJobRunnerParams)(nil),  // 3: infraboard.mpaas.job.K8sJobRunnerParams
	(*JobSet)(nil),              // 4: infraboard.mpaas.job.JobSet
	(*Job)(nil),                 // 5: infraboard.mpaas.job.Job
	(*CreateJobRequest)(nil),    // 6: infraboard.mpaas.job.CreateJobRequest
	(*VersionedRunParam)(nil),   // 7: infraboard.mpaas.job.VersionedRunParam
	(*EnumOption)(nil),          // 8: infraboard.mpaas.job.EnumOption
	(*RunParam)(nil),            // 9: infraboard.mpaas.job.RunParam
	nil,                         // 10: infraboard.mpaas.job.CreateJobRequest.LabelsEntry
	nil,                         // 11: infraboard.mpaas.job.EnumOption.ExtensionsEntry
	nil,                         // 12: infraboard.mpaas.job.RunParam.ExtensionsEntry
	(*meta.Meta)(nil),           // 13: infraboard.mpaas.common.meta.Meta
	(resource.VISIABLE_MODE)(0), // 14: infraboard.mcube.resource.VISIABLE_MODE
}
var file_apps_job_pb_job_proto_depIdxs = []int32{
	5,  // 0: infraboard.mpaas.job.JobSet.items:type_name -> infraboard.mpaas.job.Job
	13, // 1: infraboard.mpaas.job.Job.meta:type_name -> infraboard.mpaas.common.meta.Meta
	6,  // 2: infraboard.mpaas.job.Job.spec:type_name -> infraboard.mpaas.job.CreateJobRequest
	0,  // 3: infraboard.mpaas.job.CreateJobRequest.runner_type:type_name -> infraboard.mpaas.job.RUNNER_TYPE
	7,  // 4: infraboard.mpaas.job.CreateJobRequest.run_params:type_name -> infraboard.mpaas.job.VersionedRunParam
	7,  // 5: infraboard.mpaas.job.CreateJobRequest.rollback_params:type_name -> infraboard.mpaas.job.VersionedRunParam
	14, // 6: infraboard.mpaas.job.CreateJobRequest.visiable_mode:type_name -> infraboard.mcube.resource.VISIABLE_MODE
	10, // 7: infraboard.mpaas.job.CreateJobRequest.labels:type_name -> infraboard.mpaas.job.CreateJobRequest.LabelsEntry
	9,  // 8: infraboard.mpaas.job.VersionedRunParam.params:type_name -> infraboard.mpaas.job.RunParam
	11, // 9: infraboard.mpaas.job.EnumOption.extensions:type_name -> infraboard.mpaas.job.EnumOption.ExtensionsEntry
	2,  // 10: infraboard.mpaas.job.RunParam.value_type:type_name -> infraboard.mpaas.job.PARAM_VALUE_TYPE
	8,  // 11: infraboard.mpaas.job.RunParam.enum_options:type_name -> infraboard.mpaas.job.EnumOption
	12, // 12: infraboard.mpaas.job.RunParam.extensions:type_name -> infraboard.mpaas.job.RunParam.ExtensionsEntry
