...
type RunParam struct {
	...
	Desc string `protobuf:"bytes,4,opt,name=desc,proto3" json:"desc" bson:"desc"`
	// 值类型
	// @gotags: bson:"value_type" json:"value_type"
	ValueType PARAM_VALUE_TYPE `protobuf:"varint,5,opt,name=value_type,json=valueType,proto3,enum=infraboard.mpaas.job.PARAM_VALUE_TYPE" json:"value_type" bson:"value_type"`
	// 枚举值的选项
	...
	HttpEnumUrl string `protobuf:"bytes,7,opt,name=http_enum_url,json=httpEnumUrl,proto3" json:"http_enum_url,omitempty" bson:"http_enum_url"`
	// 值的样例
	...
	Value string `protobuf:"bytes,9,opt,name=value,proto3" json:"value" bson:"value"`
	// 设置了值后，不允许修改, 用于控制流水线模版变量
	// @gotags: bson:"read_olny" json:"read_olny"
	ReadOlny bool `protobuf:"varint,10,opt,name=read_olny,json=readOlny,proto3" json:"read_olny" bson:"read_olny"`
	// 扩展属性
	// @gotags: bson:"extensions" json:"extensions"
	Extensions map[string]string `protobuf:"bytes,15,rep,name=extensions,proto3" json:"extensions" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"extensions"`
}
...
var file_apps_job_pb_job_proto_rawDesc = []byte{
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xa1, 0x04, 0x0a, 0x08, 0x52, 0x75,
	...
	0x65, 0x64, 0x12, 0x45, 0x0a, 0x0a, 0x75, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65,
	...
	0x52, 0x41, 0x4d, 0x5f, 0x55, 0x53, 0x41, 0x47, 0x45, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x52, 0x09,
	0x75, 0x73, 0x61, 0x67, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d,
	...
	0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x26, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61,
	...
	0x5f, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20,
	...
	0x52, 0x0b, 0x65, 0x6e, 0x75, 0x6d, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x22, 0x0a,
	0x0d, 0x68, 0x74, 0x74, 0x70, 0x5f, 0x65, 0x6e, 0x75, 0x6d, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x68, 0x74, 0x74, 0x70, 0x45, 0x6e, 0x75, 0x6d, 0x55, 0x72,
	...
	0x65, 0x12, 0x1b, 0x0a, 0x09, 0x72, 0x65, 0x61, 0x64, 0x5f, 0x6f, 0x6c, 0x6e, 0x79, 0x18, 0x0a,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x72, 0x65, 0x61, 0x64, 0x4f, 0x6c, 0x6e, 0x79, 0x12, 0x4e,
...
var file_apps_job_pb_job_proto_goTypes = []interface{}{
	...
	(*RunParam)(nil),            // 10: infraboard.mpaas.job.RunParam
	nil,                         // 11: infraboard.mpaas.job.CreateJobRequest.LabelsEntry
	nil,                         // 12: infraboard.mpaas.job.EnumOption.ExtensionsEntry
	nil,                         // 13: infraboard.mpaas.job.RunParam.ExtensionsEntry
	(*meta.Meta)(nil),           // 14: infraboard.mpaas.common.meta.Meta
	(resource.VISIABLE_MODE)(0), // 15: infraboard.mcube.resource.VISIABLE_MODE
}
var file_apps_job_pb_job_proto_depIdxs = []int32{
	6,  // 0: infraboard.mpaas.job.JobSet.items:type_name -> infraboard.mpaas.job.Job
	14, // 1: infraboard.mpaas.job.Job.meta:type_name -> infraboard.mpaas.common.meta.Meta
	...
	15, // 6: infraboard.mpaas.job.CreateJobRequest.visiable_mode:type_name -> infraboard.mcube.resource.VISIABLE_MODE
	11, // 7: infraboard.mpaas.job.CreateJobRequest.labels:type_name -> infraboard.mpaas.job.CreateJobRequest.LabelsEntry
	10, // 8: infraboard.mpaas.job.VersionedRunParam.params:type_name -> infraboard.mpaas.job.RunParam
	12, // 9: infraboard.mpaas.job.EnumOption.extensions:type_name -> infraboard.mpaas.job.EnumOption.ExtensionsEntry
	...
	13, // 13: infraboard.mpaas.job.RunParam.extensions:type_name -> infraboard.mpaas.job.RunParam.ExtensionsEntry
