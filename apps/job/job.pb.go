...
type RunParam struct {
	...
	EnumOptions []string `protobuf:"bytes,5,rep,name=enum_options,json=enumOptions,proto3" json:"enum_options,omitempty" bson:"enum_options"`
	// 基于枚举的URL
...
func (x *RunParam) GetEnumOptions() []string {
	if x != nil {
...
var file_apps_job_pb_job_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x61, 0x6d, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x22, 0x9b, 0x03, 0x0a,
	...
	0x63, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x65, 0x73, 0x63, 0x12, 0x45, 0x0a,
	...
	0x70, 0x61, 0x61, 0x73, 0x2e, 0x6a, 0x6f, 0x62, 0x2e, 0x50, 0x41, 0x52, 0x41, 0x4d, 0x5f, 0x56,
	0x41, 0x4c, 0x55, 0x45, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x52, 0x09, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x54, 0x79, 0x70, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x65, 0x6e, 0x75, 0x6d, 0x5f, 0x6f, 0x70, 0x74,
	0x69, 0x6f, 0x6e, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0b, 0x65, 0x6e, 0x75, 0x6d,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x4e, 0x0a, 0x0a, 0x65,
	...
	0x5f, 0x4a, 0x4f, 0x42, 0x10, 0x00, 0x2a, 0x35, 0x0a, 0x10, 0x50, 0x41, 0x52, 0x41, 0x4d, 0x5f,
	0x56, 0x41, 0x4c, 0x55, 0x45, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x12, 0x08, 0x0a, 0x04, 0x54, 0x45,
	0x58, 0x54, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x45, 0x4e, 0x55, 0x4d, 0x10, 0x01, 0x12, 0x0d,
	0x0a, 0x09, 0x48, 0x54, 0x54, 0x50, 0x5f, 0x45, 0x4e, 0x55, 0x4d, 0x10, 0x02, 0x42, 0x26, 0x5a,
...
var file_apps_job_pb_job_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_apps_job_pb_job_proto_goTypes = []interface{}{
	...
	(*RunParam)(nil),            // 7: infraboard.mpaas.job.RunParam
	nil,                         // 8: infraboard.mpaas.job.CreateJobRequest.LabelsEntry
	nil,                         // 9: infraboard.mpaas.job.RunParam.ExtensionsEntry
	(*meta.Meta)(nil),           // 10: infraboard.mpaas.common.meta.Meta
	(resource.VISIABLE_MODE)(0), // 11: infraboard.mcube.resource.VISIABLE_MODE
}
var file_apps_job_pb_job_proto_depIdxs = []int32{
	4,  // 0: infraboard.mpaas.job.JobSet.items:type_name -> infraboard.mpaas.job.Job
	10, // 1: infraboard.mpaas.job.Job.meta:type_name -> infraboard.mpaas.common.meta.Meta
	...
	11, // 5: infraboard.mpaas.job.CreateJobRequest.visiable_mode:type_name -> infraboard.mcube.resource.VISIABLE_MODE
	8,  // 6: infraboard.mpaas.job.CreateJobRequest.labels:type_name -> infraboard.mpaas.job.CreateJobRequest.LabelsEntry
	7,  // 7: infraboard.mpaas.job.VersionedRunParam.params:type_name -> infraboard.mpaas.job.RunParam
	1,  // 8: infraboard.mpaas.job.RunParam.value_type:type_name -> infraboard.mpaas.job.PARAM_VALUE_TYPE
	9,  // 9: infraboard.mpaas.job.RunParam.extensions:type_name -> infraboard.mpaas.job.RunParam.ExtensionsEntry
