...
var file_apps_task_pb_pipeline_rpc_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x03, 0x69, 0x64, 0x73, 0x32, 0xda, 0x01, 0x0a, 0x0b, 0x50, 0x69, 0x70, 0x65, 0x6c,
	0x69, 0x6e, 0x65, 0x52, 0x50, 0x43, 0x12, 0x5d, 0x0a, 0x0b, 0x52, 0x75, 0x6e, 0x50, 0x69, 0x70,
	0x65, 0x6c, 0x69, 0x6e, 0x65, 0x12, 0x29, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61,
...
var file_apps_task_pb_pipeline_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_apps_task_pb_pipeline_rpc_proto_goTypes = []interface{}{
	...
	(*PipelineTask)(nil),             // 3: infraboard.mpaas.task.PipelineTask
	(*PipelineTaskSet)(nil),          // 4: infraboard.mpaas.task.PipelineTaskSet
}
var file_apps_task_pb_pipeline_rpc_proto_depIdxs = []int32{
	2, // 0: infraboard.mpaas.task.QueryPipelineTaskRequest.page:type_name -> infraboard.mcube.page.PageRequest
	...
	3, // 3: infraboard.mpaas.task.PipelineRPC.RunPipeline:output_type -> infraboard.mpaas.task.PipelineTask
	4, // 4: infraboard.mpaas.task.PipelineRPC.QueryPipelineTask:output_type -> infraboard.mpaas.task.PipelineTaskSet
