...
type Task struct {
	...
	Job *job.Job `protobuf:"bytes,1,opt,name=job,proto3" json:"job" bson:"job"`
}
...
var file_apps_task_pb_task_proto_rawDesc = []byte{
	...
	0x54, 0x61, 0x73, 0x6b, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x33, 0x0a, 0x04, 0x54,
	0x61, 0x73, 0x6b, 0x12, 0x2b, 0x0a, 0x03, 0x6a, 0x6f, 0x62, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x19, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x70,
	0x61, 0x61, 0x73, 0x2e, 0x6a, 0x6f, 0x62, 0x2e, 0x4a, 0x6f, 0x62, 0x52, 0x03, 0x6a, 0x6f, 0x62,
...
var file_apps_task_pb_task_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_apps_task_pb_task_proto_goTypes = []interface{}{
	...
	(*job.Job)(nil), // 2: infraboard.mpaas.job.Job
}
var file_apps_task_pb_task_proto_depIdxs = []int32{
	...
	2, // 1: infraboard.mpaas.task.Task.job:type_name -> infraboard.mpaas.job.Job
