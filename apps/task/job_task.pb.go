...
var file_apps_task_pb_job_task_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x08, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x79, 0x22, 0xc8, 0x02, 0x0a, 0x0d,
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x22, 0x96, 0x01, 0x0a, 0x0a, 0x52, 0x75, 0x6e, 0x74, 0x69,
	...
	0x77, 0x0a, 0x11, 0x54, 0x65, 0x6d, 0x70, 0x6f, 0x72, 0x61, 0x72, 0x79, 0x52, 0x65, 0x73, 0x6f,
	...
	0x65, 0x61, 0x73, 0x65, 0x5f, 0x61, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x72,
	...
	0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0x59, 0x0a, 0x05,
	...
	0x0a, 0x08, 0x43, 0x41, 0x4e, 0x43, 0x45, 0x4c, 0x45, 0x44, 0x10, 0x0a, 0x12, 0x0d, 0x0a, 0x09,
	0x53, 0x55, 0x43, 0x43, 0x45, 0x45, 0x44, 0x45, 0x44, 0x10, 0x0b, 0x12, 0x0a, 0x0a, 0x06, 0x46,
	0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x0c, 0x42, 0x27, 0x5a, 0x25, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_apps_task_pb_job_task_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_apps_task_pb_job_task_proto_goTypes = []interface{}{
	...
	(*RuntimeEnv)(nil),             // 5: infraboard.mpaas.task.RuntimeEnv
	(*TemporaryResource)(nil),      // 6: infraboard.mpaas.task.TemporaryResource
	(*RunTaskRequest)(nil),         // 7: infraboard.mpaas.task.RunTaskRequest
	nil,                            // 8: infraboard.mpaas.task.RunTaskRequest.LabelsEntry
	(*pipeline.RunJobRequest)(nil), // 9: infraboard.mpaas.pipeline.RunJobRequest
	(*job.Job)(nil),                // 10: infraboard.mpaas.job.Job
...
var file_apps_task_pb_job_task_proto_depIdxs = []int32{
	...
	9,  // 2: infraboard.mpaas.task.JobTask.spec:type_name -> infraboard.mpaas.pipeline.RunJobRequest
	4,  // 3: infraboard.mpaas.task.JobTask.status:type_name -> infraboard.mpaas.task.JobTaskStatus
	10, // 4: infraboard.mpaas.task.JobTask.job:type_name -> infraboard.mpaas.job.Job
	0,  // 5: infraboard.mpaas.task.JobTaskStatus.stage:type_name -> infraboard.mpaas.task.STAGE
	5,  // 6: infraboard.mpaas.task.JobTaskStatus.runtime_envs:type_name -> infraboard.mpaas.task.RuntimeEnv
	6,  // 7: infraboard.mpaas.task.JobTaskStatus.temporary_resources:type_name -> infraboard.mpaas.task.TemporaryResource
	11, // 8: infraboard.mpaas.task.RunTaskRequest.params:type_name -> infraboard.mpaas.job.VersionedRunParam
	8,  // 9: infraboard.mpaas.task.RunTaskRequest.labels:type_name -> infraboard.mpaas.task.RunTaskRequest.LabelsEntry
