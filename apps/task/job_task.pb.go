...
var file_apps_task_pb_job_task_proto_rawDesc = []byte{
	...
	0x50, 0x61, 0x72, 0x61, 0x6d, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x2a, 0x3c, 0x0a,
	...
	0x0a, 0x0a, 0x06, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x03, 0x42, 0x27, 0x5a, 0x25, 0x67,
...
var file_apps_task_pb_job_task_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_apps_task_pb_job_task_proto_goTypes = []interface{}{
	...
	(*pipeline.RunJobRequest)(nil), // 5: infraboard.mpaas.pipeline.RunJobRequest
...
var file_apps_task_pb_job_task_proto_depIdxs = []int32{
	...
	5, // 1: infraboard.mpaas.task.JobTask.spec:type_name -> infraboard.mpaas.pipeline.RunJobRequest
	6, // 2: infraboard.mpaas.task.JobTask.job:type_name -> infraboard.mpaas.job.Job
	...
	7, // 5: infraboard.mpaas.task.RunTaskRequest.params:type_name -> infraboard.mpaas.job.VersionedRunParam
