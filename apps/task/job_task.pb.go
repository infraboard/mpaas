...
type CallbackStatus struct {
	...
	Message string `protobuf:"bytes,4,opt,name=message,proto3" json:"message" bson:"message"`
	// 异常时的详细信息描述
	// @gotags: bson:"details" json:"details"
	Details []*Event `protobuf:"bytes,6,rep,name=details,proto3" json:"details" bson:"details"`
}
...
func (x *CallbackStatus) GetDetails() []*Event {
	if x != nil {
		return x.Details
	}
	return nil
...
var file_apps_task_pb_job_task_proto_rawDesc = []byte{
	...
	0xcd, 0x01, 0x0a, 0x0e, 0x43, 0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x53, 0x74, 0x61, 0x74,
	...
	0x6c, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61,
	0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x70, 0x61, 0x61, 0x73, 0x2e, 0x74, 0x61, 0x73, 0x6b,
	0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x22,
...
var file_apps_task_pb_job_task_proto_depIdxs = []int32{
	...
	7,  // 11: infraboard.mpaas.task.CallbackStatus.details:type_name -> infraboard.mpaas.task.Event
