...
func (x *CallbackStatus) GetDetail() string {
	if x != nil {
		return x.Detail
	}
	return ""
...
var file_apps_task_pb_job_task_proto_rawDesc = []byte{
	...
	0xad, 0x01, 0x0a, 0x0e, 0x43, 0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x53, 0x74, 0x61, 0x74,
...
var file_apps_task_pb_job_task_proto_depIdxs = []int32{
	...
	1,  // 11: infraboard.mpaas.task.Event.level:type_name -> infraboard.mpaas.task.EVENT_LEVEL
	14, // 12: infraboard.mpaas.task.RunTaskRequest.params:type_name -> infraboard.mpaas.job.VersionedRunParam
	11, // 13: infraboard.mpaas.task.RunTaskRequest.labels:type_name -> infraboard.mpaas.task.RunTaskRequest.LabelsEntry
