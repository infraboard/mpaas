...
type JobTask struct {
	...
	Spec *pipeline.RunJobRequest `protobuf:"bytes,3,opt,name=spec,proto3" json:"spec" bson:",inline"`
	// 关联Job
	// @gotags: bson:"job" json:"job"
	Job *job.Job `protobuf:"bytes,4,opt,name=job,proto3" json:"job" bson:"job"`
	// 任务当前状态
	// @gotags: bson:"status" json:"status"
	Status *JobTaskStatus `protobuf:"bytes,15,opt,name=status,proto3" json:"status" bson:"status"`
}
...
func (x *JobTask) GetMeta() *meta.Meta {
	if x != nil {
		return x.Meta
	}
	return nil
...
var file_apps_task_pb_job_task_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x16, 0x63, 0x6f,
	0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x6d, 0x65, 0x74, 0x61, 0x2f, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x58, 0x0a, 0x0a, 0x4a, 0x6f, 0x62, 0x54, 0x61, 0x73, 0x6b, 0x53,
	...
	0x4a, 0x6f, 0x62, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0xea,
	0x01, 0x0a, 0x07, 0x4a, 0x6f, 0x62, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x36, 0x0a, 0x04, 0x6d, 0x65,
	...
	0x12, 0x2b, 0x0a, 0x03, 0x6a, 0x6f, 0x62, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e,
	0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x70, 0x61, 0x61, 0x73,
	0x2e, 0x6a, 0x6f, 0x62, 0x2e, 0x4a, 0x6f, 0x62, 0x52, 0x03, 0x6a, 0x6f, 0x62, 0x12, 0x3c, 0x0a,
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e,
	0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x70, 0x61, 0x61, 0x73,
	0x2e, 0x74, 0x61, 0x73, 0x6b, 0x2e, 0x4a, 0x6f, 0x62, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xa7, 0x01, 0x0a, 0x0d,
...
var file_apps_task_pb_job_task_proto_depIdxs = []int32{
	...
	6, // 1: infraboard.mpaas.task.JobTask.meta:type_name -> infraboard.mpaas.common.meta.Meta
	7, // 2: infraboard.mpaas.task.JobTask.spec:type_name -> infraboard.mpaas.pipeline.RunJobRequest
	8, // 3: infraboard.mpaas.task.JobTask.job:type_name -> infraboard.mpaas.job.Job
	3, // 4: infraboard.mpaas.task.JobTask.status:type_name -> infraboard.mpaas.task.JobTaskStatus
	...
	5, // 7: infraboard.mpaas.task.RunTaskRequest.labels:type_name -> infraboard.mpaas.task.RunTaskRequest.LabelsEntry
