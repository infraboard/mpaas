...
var file_mpaas_apps_task_pb_job_rpc_proto_rawDesc = []byte{
	...
	0x32, 0x40, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x70,
...
var file_mpaas_apps_task_pb_job_rpc_proto_goTypes = []interface{}{
	...
	nil,                                // 8: infraboard.mpaas.task.UpdateJobTaskStatusRequest.ExtensionEntry
	...
	(STAGE)(0),                         // 12: infraboard.mpaas.task.STAGE
	(*job.RunParam)(nil),               // 13: infraboard.mpaas.job.RunParam
	(*JobTaskSet)(nil),                 // 14: infraboard.mpaas.task.JobTaskSet
	(*JobTask)(nil),                    // 15: infraboard.mpaas.task.JobTask
}
var file_mpaas_apps_task_pb_job_rpc_proto_depIdxs = []int32{
	9,  // 0: infraboard.mpaas.task.QueryJobTaskRequest.scope:type_name -> infraboard.mcube.resource.Scope
	10, // 1: infraboard.mpaas.task.QueryJobTaskRequest.filters:type_name -> infraboard.mcube.resource.LabelRequirement
	11, // 2: infraboard.mpaas.task.QueryJobTaskRequest.page:type_name -> infraboard.mcube.page.PageRequest
	12, // 3: infraboard.mpaas.task.QueryJobTaskRequest.stage:type_name -> infraboard.mpaas.task.STAGE
	7,  // 4: infraboard.mpaas.task.QueryJobTaskRequest.labels:type_name -> infraboard.mpaas.task.QueryJobTaskRequest.LabelsEntry
	12, // 5: infraboard.mpaas.task.UpdateJobTaskStatusRequest.stage:type_name -> infraboard.mpaas.task.STAGE
	8,  // 6: infraboard.mpaas.task.UpdateJobTaskStatusRequest.extension:type_name -> infraboard.mpaas.task.UpdateJobTaskStatusRequest.ExtensionEntry
	13, // 7: infraboard.mpaas.task.UpdateJobTaskOutputRequest.runtime_envs:type_name -> infraboard.mpaas.job.RunParam
	2,  // 8: infraboard.mpaas.task.JobRPC.QueryJobTask:input_type -> infraboard.mpaas.task.QueryJobTaskRequest
	3,  // 9: infraboard.mpaas.task.JobRPC.UpdateJobTaskStatus:input_type -> infraboard.mpaas.task.UpdateJobTaskStatusRequest
	4,  // 10: infraboard.mpaas.task.JobRPC.UpdateJobTaskOutput:input_type -> infraboard.mpaas.task.UpdateJobTaskOutputRequest
	5,  // 11: infraboard.mpaas.task.JobRPC.DescribeJobTask:input_type -> infraboard.mpaas.task.DescribeJobTaskRequest
	0,  // 12: infraboard.mpaas.task.JobRPC.WatchJobTaskLog:input_type -> infraboard.mpaas.task.WatchJobTaskLogRequest
	14, // 13: infraboard.mpaas.task.JobRPC.QueryJobTask:output_type -> infraboard.mpaas.task.JobTaskSet
	15, // 14: infraboard.mpaas.task.JobRPC.UpdateJobTaskStatus:output_type -> infraboard.mpaas.task.JobTask
	15, // 15: infraboard.mpaas.task.JobRPC.UpdateJobTaskOutput:output_type -> infraboard.mpaas.task.JobTask
	15, // 16: infraboard.mpaas.task.JobRPC.DescribeJobTask:output_type -> infraboard.mpaas.task.JobTask
	1,  // 17: infraboard.mpaas.task.JobRPC.WatchJobTaskLog:output_type -> infraboard.mpaas.task.JobTaskStreamReponse
