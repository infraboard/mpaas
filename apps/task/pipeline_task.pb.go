...
var file_apps_task_pb_pipeline_task_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x75, 0x73, 0x22, 0x5a, 0x0a, 0x12, 0x52, 0x75, 0x6e, 0x50, 0x69, 0x70, 0x65, 0x6c,
...
var file_apps_task_pb_pipeline_task_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_apps_task_pb_pipeline_task_proto_goTypes = []interface{}{
	...
	(*Meta)(nil),               // 5: infraboard.mpaas.task.Meta
...
var file_apps_task_pb_pipeline_task_proto_depIdxs = []int32{
	...
	5, // 1: infraboard.mpaas.task.PipelineTask.meta:type_name -> infraboard.mpaas.task.Meta
	...
	4, // 6: infraboard.mpaas.task.PipelineTaskStatus.stage_status:type_name -> infraboard.mpaas.task.StageStatus
	8, // 7: infraboard.mpaas.task.StageStatus.job_tasks:type_name -> infraboard.mpaas.task.JobTask
