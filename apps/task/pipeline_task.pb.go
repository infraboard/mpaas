...
type StageStatus struct {
	...
	Spec *pipeline.Stage `protobuf:"bytes,1,opt,name=spec,proto3" json:"spec" bson:"spec"`
...
func (x *StageStatus) GetSpec() *pipeline.Stage {
	if x != nil {
		return x.Spec
	}
	return nil
...
var file_apps_task_pb_pipeline_task_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xb4, 0x01, 0x0a, 0x0b, 0x53, 0x74, 0x61,
	0x67, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x34, 0x0a, 0x04, 0x73, 0x70, 0x65, 0x63,
	...
	0x6e, 0x65, 0x2e, 0x53, 0x74, 0x61, 0x67, 0x65, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x12, 0x32,
	...
	0x67, 0x65, 0x12, 0x3b, 0x0a, 0x09, 0x6a, 0x6f, 0x62, 0x5f, 0x74, 0x61, 0x73, 0x6b, 0x73, 0x18,
	...
	0x62, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x08, 0x6a, 0x6f, 0x62, 0x54, 0x61, 0x73, 0x6b, 0x73, 0x42,
...
var file_apps_task_pb_pipeline_task_proto_goTypes = []interface{}{
	...
	(*pipeline.Stage)(nil),     // 6: infraboard.mpaas.pipeline.Stage
...
var file_apps_task_pb_pipeline_task_proto_depIdxs = []int32{
	...
	6, // 5: infraboard.mpaas.task.StageStatus.spec:type_name -> infraboard.mpaas.pipeline.Stage
	5, // 6: infraboard.mpaas.task.StageStatus.stage:type_name -> infraboard.mpaas.task.STAGE
	7, // 7: infraboard.mpaas.task.StageStatus.job_tasks:type_name -> infraboard.mpaas.task.JobTask
