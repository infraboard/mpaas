...
const (
	JobRPC_RunJob_FullMethodName              = "/infraboard.mpaas.task.JobRPC/RunJob"
	...
	JobRPC_DeleteJobTask_FullMethodName       = "/infraboard.mpaas.task.JobRPC/DeleteJobTask"
)
...
func (c *jobRPCClient) RunJob(ctx context.Context, in *pipeline.RunJobRequest, opts ...grpc.CallOption) (*JobTask, error) {
	out := new(JobTask)
	err := c.cc.Invoke(ctx, JobRPC_RunJob_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobRPCClient) DeleteJobTask(ctx context.Context, in *DeleteJobTaskRequest, opts ...grpc.CallOption) (*JobTask, error) {
	out := new(JobTask)
	err := c.cc.Invoke(ctx, JobRPC_DeleteJobTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _JobRPC_RunJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: JobRPC_RunJob_FullMethodName,
	}
...
func _JobRPC_DeleteJobTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: JobRPC_DeleteJobTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
