...
var file_mpaas_apps_cluster_pb_cluster_proto_rawDesc = []byte{
	...
	0x65, 0x52, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0xf4, 0x01, 0x0a, 0x14, 0x43,
	...
	0x62, 0x65, 0x12, 0x52, 0x0a, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x18, 0x0f, 0x20, 0x03,
...
var file_mpaas_apps_cluster_pb_cluster_proto_goTypes = []interface{}{
	...
	(*service.Service)(nil),      // 7: infraboard.mcenter.service.Service
}
var file_mpaas_apps_cluster_pb_cluster_proto_depIdxs = []int32{
	...
	7, // 5: infraboard.mpaas.cluster.Cluster.service:type_name -> infraboard.mcenter.service.Service
	3, // 6: infraboard.mpaas.cluster.CreateClusterRequest.labels:type_name -> infraboard.mpaas.cluster.CreateClusterRequest.LabelsEntry
