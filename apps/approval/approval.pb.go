...
type CreateApprovalRequest struct {
	...
	Proposers []string `protobuf:"bytes,4,rep,name=proposers,proto3" json:"proposers" bson:"proposers"`
	// 审核人列表
	// @gotags: bson:"auditors" json:"auditors"
	Auditors []string `protobuf:"bytes,5,rep,name=auditors,proto3" json:"auditors" bson:"auditors"`
	// 发布号
	// @gotags: bson:"version" json:"version" validate:"required"
	Version string `protobuf:"bytes,6,opt,name=version,proto3" json:"version" bson:"version" validate:"required"`
	// 发布说明
	// @gotags: bson:"describe" json:"describe" validate:"required"
	Describe string `protobuf:"bytes,7,opt,name=describe,proto3" json:"describe" bson:"describe" validate:"required"`
	// 审核通过后, 是否自动执行发布, 默认审核通过后手动发布
	// @gotags: bson:"auto_publish" json:"auto_publish"
	AutoPublish bool `protobuf:"varint,8,opt,name=auto_publish,json=autoPublish,proto3" json:"auto_publish" bson:"auto_publish"`
	// 流水线配置
	// @gotags: bson:"-" json:"pipeline_spec,omitempty"
	PipelineSpec *pipeline.CreatePipelineRequest `protobuf:"bytes,9,opt,name=pipeline_spec,json=pipelineSpec,proto3" json:"pipeline_spec,omitempty" bson:"-"`
	// 流水线Id
	// @gotags: bson:"pipeline_id" json:"pipeline_id"
	PipelineId string `protobuf:"bytes,10,opt,name=pipeline_id,json=pipelineId,proto3" json:"pipeline_id" bson:"pipeline_id"`
	// 申请单标签
...
var file_apps_approval_pb_approval_proto_rawDesc = []byte{
	...
	0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x8a, 0x04, 0x0a, 0x15, 0x43, 0x72,
	...
	0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a,
	0x69, 0x73, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x70, 0x72,
	0x6f, 0x70, 0x6f, 0x73, 0x65, 0x72, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x70,
	0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x72, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x61, 0x75, 0x64, 0x69,
	0x74, 0x6f, 0x72, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x61, 0x75, 0x64, 0x69,
	...
	0x52, 0x08, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x61, 0x75,
	0x74, 0x6f, 0x5f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x18, 0x08, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x0b, 0x61, 0x75, 0x74, 0x6f, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x12, 0x55, 0x0a,
	0x0d, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x5f, 0x73, 0x70, 0x65, 0x63, 0x18, 0x09,
	...
	0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x70, 0x69, 0x70, 0x65, 0x6c,
	0x69, 0x6e, 0x65, 0x49, 0x64, 0x12, 0x54, 0x0a, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x18,
	0x0f, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3c, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61,
	...
	,
	...
	,
