...
type CreateApprovalRequest struct {
	...
	// 发布项列表
	// @gotags: bson:"publish_items" json:"publish_items"
	PublishItems *PublishItemSet `protobuf:"bytes,9,opt,name=publish_items,json=publishItems,proto3" json:"publish_items" bson:"publish_items"`
	// 申请单标签
...
func (x *CreateApprovalRequest) GetPublishItems() *PublishItemSet {
	if x != nil {
		return x.PublishItems
	}
	return nil
}
...
type PublishItemSet struct {
	...
	// 发布项列表
	// @gotags: bson:"items" json:"items"
	Items []*PublishItem `protobuf:"bytes,1,rep,name=items,proto3" json:"items" bson:"items"`
}

func (x *PublishItemSet) Reset() {
	*x = PublishItemSet{}
	if protoimpl.UnsafeEnabled {
...
func (x *PublishItemSet) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PublishItemSet) ProtoMessage() {}

func (x *PublishItemSet) ProtoReflect() protoreflect.Message {
	mi := &file_apps_approval_pb_approval_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PublishItemSet.ProtoReflect.Descriptor instead.
func (*PublishItemSet) Descriptor() ([]byte, []int) {
	return file_apps_approval_pb_approval_proto_rawDescGZIP(), []int{3}
}

func (x *PublishItemSet) GetItems() []*PublishItem {
	if x != nil {
		return x.Items
	}
	return nil
...
type PublishItem struct {
	...
	DeployId string `protobuf:"bytes,1,opt,name=deploy_id,json=deployId,proto3" json:"deploy_id" bson:"deploy_id"`
	// 当前版本, 记录下当前版本 用于回滚
	// @gotags: bson:"current_version" json:"current_version"
	CurrentVersion string `protobuf:"bytes,2,opt,name=current_version,json=currentVersion,proto3" json:"current_version" bson:"current_version"`
	// 需要升级的版本
	// @gotags: bson:"upgrade_version" json:"upgrade_version"
	UpgradeVersion string `protobuf:"bytes,3,opt,name=upgrade_version,json=upgradeVersion,proto3" json:"upgrade_version" bson:"upgrade_version"`
}
...
func (x *PublishItem) GetDeployId() string {
	if x != nil {
		return x.DeployId
	}
	return ""
...
func (x *PublishItem) GetCurrentVersion() string {
	if x != nil {
...
func (x *PublishItem) GetUpgradeVersion() string {
	if x != nil {
...
func (x *Status) Reset() {
	*x = Status{}
	if protoimpl.UnsafeEnabled {
		mi := &file_apps_approval_pb_approval_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Status) Descriptor() ([]byte, []int) {
	return file_apps_approval_pb_approval_proto_rawDescGZIP(), []int{5}
}
...
var file_apps_approval_pb_approval_proto_rawDesc = []byte{
	...
	0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xbe, 0x04, 0x0a, 0x15, 0x43, 0x72,
	...
	,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x4e, 0x0a, 0x0e, 0x50, 0x75,
	0x62, 0x6c, 0x69, 0x73, 0x68, 0x49, 0x74, 0x65, 0x6d, 0x53, 0x65, 0x74, 0x12, 0x3c, 0x0a, 0x05,
	...
	0x70, 0x70, 0x72, 0x6f, 0x76, 0x61, 0x6c, 0x2e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x49,
	0x74, 0x65, 0x6d, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x7c, 0x0a, 0x0b, 0x50, 0x75,
	0x62, 0x6c, 0x69, 0x73, 0x68, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x1b, 0x0a, 0x09, 0x64, 0x65, 0x70,
	0x6c, 0x6f, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x64, 0x65,
	0x70, 0x6c, 0x6f, 0x79, 0x49, 0x64, 0x12, 0x27, 0x0a, 0x0f, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e,
	...
	,
	...
	,
	...
	0x45, 0x44, 0x10, 0x0c, 0x12, 0x0a, 0x0a, 0x06, 0x43, 0x4c, 0x4f, 0x53, 0x45, 0x44, 0x10, 0x0f,
...
var file_apps_approval_pb_approval_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_apps_approval_pb_approval_proto_goTypes = []interface{}{
	...
	(*PublishItemSet)(nil),                 // 4: infraboard.mpaas.approval.PublishItemSet
	(*PublishItem)(nil),                    // 5: infraboard.mpaas.approval.PublishItem
	(*Status)(nil),                         // 6: infraboard.mpaas.approval.Status
	nil,                                    // 7: infraboard.mpaas.approval.CreateApprovalRequest.LabelsEntry
	(*meta.Meta)(nil),                      // 8: infraboard.mpaas.common.meta.Meta
	(*pipeline.Pipeline)(nil),              // 9: infraboard.mpaas.pipeline.Pipeline
	(*pipeline.CreatePipelineRequest)(nil), // 10: infraboard.mpaas.pipeline.CreatePipelineRequest
}
var file_apps_approval_pb_approval_proto_depIdxs = []int32{
	...
	8,  // 1: infraboard.mpaas.approval.Approval.meta:type_name -> infraboard.mpaas.common.meta.Meta
	3,  // 2: infraboard.mpaas.approval.Approval.spec:type_name -> infraboard.mpaas.approval.CreateApprovalRequest
	9,  // 3: infraboard.mpaas.approval.Approval.deploy_pipeline:type_name -> infraboard.mpaas.pipeline.Pipeline
	6,  // 4: infraboard.mpaas.approval.Approval.status:type_name -> infraboard.mpaas.approval.Status
	10, // 5: infraboard.mpaas.approval.CreateApprovalRequest.deploy_pipeline_spec:type_name -> infraboard.mpaas.pipeline.CreatePipelineRequest
	4,  // 6: infraboard.mpaas.approval.CreateApprovalRequest.publish_items:type_name -> infraboard.mpaas.approval.PublishItemSet
	7,  // 7: infraboard.mpaas.approval.CreateApprovalRequest.labels:type_name -> infraboard.mpaas.approval.CreateApprovalRequest.LabelsEntry
	5,  // 8: infraboard.mpaas.approval.PublishItemSet.items:type_name -> infraboard.mpaas.approval.PublishItem
...
func file_apps_approval_pb_approval_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_apps_approval_pb_approval_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Status); i {
			case 0:
				return &v.state
			case 1:
