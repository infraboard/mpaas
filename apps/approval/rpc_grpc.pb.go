...
const (
	RPC_CreateApproval_FullMethodName       = "/infraboard.mpaas.approval.RPC/CreateApproval"
	RPC_QueryApproval_FullMethodName        = "/infraboard.mpaas.approval.RPC/QueryApproval"
	RPC_DescribeApproval_FullMethodName     = "/infraboard.mpaas.approval.RPC/DescribeApproval"
	RPC_EditApproval_FullMethodName         = "/infraboard.mpaas.approval.RPC/EditApproval"
	RPC_UpdateApprovalStatus_FullMethodName = "/infraboard.mpaas.approval.RPC/UpdateApprovalStatus"
)
