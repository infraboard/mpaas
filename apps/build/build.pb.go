...
var file_apps_build_pb_build_proto_rawDesc = []byte{
	...
	0x03, 0x28, 0x09, 0x52, 0x08, 0x62, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x65, 0x73, 0x22, 0xfc, 0x02,
	...
	0x76, 0x5f, 0x76, 0x61, 0x72, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3a, 0x2e, 0x69,
	0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x70, 0x61, 0x61, 0x73, 0x2e,
	...
	0x0f, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x33, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61,
	...
	0x12, 0x47, 0x0a, 0x05, 0x65, 0x78, 0x74, 0x72, 0x61, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x31, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x70, 0x61,
	0x61, 0x73, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e, 0x50, 0x6b, 0x67, 0x42, 0x75, 0x69, 0x6c,
	0x64, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x45, 0x78, 0x74, 0x72, 0x61, 0x45, 0x6e, 0x74,
	...
	0x02, 0x38, 0x01, 0x2a, 0x21, 0x0a, 0x0b, 0x54, 0x41, 0x52, 0x47, 0x45, 0x54, 0x5f, 0x54, 0x59,
...
var file_apps_build_pb_build_proto_goTypes = []interface{}{
	...
	(*meta.Meta)(nil),                // 11: infraboard.mpaas.common.meta.Meta
}
var file_apps_build_pb_build_proto_depIdxs = []int32{
	...
	11, // 1: infraboard.mpaas.build.BuildConfig.meta:type_name -> infraboard.mpaas.common.meta.Meta
	3,  // 2: infraboard.mpaas.build.BuildConfig.spec:type_name -> infraboard.mpaas.build.CreateBuildConfigRequest
	4,  // 3: infraboard.mpaas.build.CreateBuildConfigRequest.condition:type_name -> infraboard.mpaas.build.Trigger
	0,  // 4: infraboard.mpaas.build.CreateBuildConfigRequest.target_type:type_name -> infraboard.mpaas.build.TARGET_TYPE
	5,  // 5: infraboard.mpaas.build.CreateBuildConfigRequest.image_build:type_name -> infraboard.mpaas.build.ImageBuildConfig
	6,  // 6: infraboard.mpaas.build.CreateBuildConfigRequest.pkg_build:type_name -> infraboard.mpaas.build.PkgBuildConfig
	7,  // 7: infraboard.mpaas.build.CreateBuildConfigRequest.labels:type_name -> infraboard.mpaas.build.CreateBuildConfigRequest.LabelsEntry
	8,  // 8: infraboard.mpaas.build.ImageBuildConfig.build_env_vars:type_name -> infraboard.mpaas.build.ImageBuildConfig.BuildEnvVarsEntry
	9,  // 9: infraboard.mpaas.build.ImageBuildConfig.extra:type_name -> infraboard.mpaas.build.ImageBuildConfig.ExtraEntry
	10, // 10: infraboard.mpaas.build.PkgBuildConfig.extra:type_name -> infraboard.mpaas.build.PkgBuildConfig.ExtraEntry
