...
var file_apps_build_pb_rpc_proto_rawDesc = []byte{
	...
	0xbb, 0x01, 0x0a, 0x11, 0x51, 0x75, 0x65, 0x72, 0x79, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x52, 0x65,
	...
	,
	...
	0x42, 0x75, 0x69, 0x6c, 0x64, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x65, 0x74, 0x42, 0x28, 0x5a, 0x26,
...
var file_apps_build_pb_rpc_proto_goTypes = []interface{}{
	...
	(*QueryBuildRequest)(nil),   // 2: infraboard.mpaas.build.QueryBuildRequest
	(*request.PageRequest)(nil), // 3: infraboard.mcube.page.PageRequest
	(*BuildTask)(nil),           // 4: infraboard.mpaas.build.BuildTask
	(*BuildTaskSet)(nil),        // 5: infraboard.mpaas.build.BuildTaskSet
}
var file_apps_build_pb_rpc_proto_depIdxs = []int32{
	...
	3, // 1: infraboard.mpaas.build.QueryBuildRequest.page:type_name -> infraboard.mcube.page.PageRequest
	0, // 2: infraboard.mpaas.build.RPC.RunBuild:input_type -> infraboard.mpaas.build.RunBuildRequest
	2, // 3: infraboard.mpaas.build.RPC.QueryBuild:input_type -> infraboard.mpaas.build.QueryBuildRequest
	4, // 4: infraboard.mpaas.build.RPC.RunBuild:output_type -> infraboard.mpaas.build.BuildTask
	5, // 5: infraboard.mpaas.build.RPC.QueryBuild:output_type -> infraboard.mpaas.build.BuildTaskSet
