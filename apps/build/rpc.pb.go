...
var file_mpaas_apps_build_pb_rpc_proto_rawDesc = []byte{
	...
	0x70, 0x61, 0x61, 0x73, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e, 0x41, 0x75, 0x74, 0x6f, 0x44,
	...
	0x6d, 0x70, 0x61, 0x61, 0x73, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e, 0x44, 0x65, 0x6c, 0x65,
	0x74, 0x65, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x65, 0x71,
...
var file_mpaas_apps_build_pb_rpc_proto_goTypes = []interface{}{
	...
	(*CreateBuildConfigRequest)(nil),  // 10: infraboard.mpaas.build.CreateBuildConfigRequest
	(*BuildConfig)(nil),               // 11: infraboard.mpaas.build.BuildConfig
	(*BuildConfigSet)(nil),            // 12: infraboard.mpaas.build.BuildConfigSet
}
var file_mpaas_apps_build_pb_rpc_proto_depIdxs = []int32{
	...
	6,  // 1: infraboard.mpaas.build.QueryBuildConfigRequest.scope:type_name -> infraboard.mcube.resource.Scope
	7,  // 2: infraboard.mpaas.build.QueryBuildConfigRequest.filters:type_name -> infraboard.mcube.resource.LabelRequirement
	8,  // 3: infraboard.mpaas.build.QueryBuildConfigRequest.page:type_name -> infraboard.mcube.page.PageRequest
	9,  // 4: infraboard.mpaas.build.UpdateBuildConfigRequest.update_mode:type_name -> infraboard.mcube.request.UpdateMode
	10, // 5: infraboard.mpaas.build.UpdateBuildConfigRequest.spec:type_name -> infraboard.mpaas.build.CreateBuildConfigRequest
	10, // 6: infraboard.mpaas.build.RPC.CreateBuildConfig:input_type -> infraboard.mpaas.build.CreateBuildConfigRequest
	2,  // 7: infraboard.mpaas.build.RPC.QueryBuildConfig:input_type -> infraboard.mpaas.build.QueryBuildConfigRequest
	5,  // 8: infraboard.mpaas.build.RPC.DescribeBuildConfig:input_type -> infraboard.mpaas.build.DescribeBuildConfigRequst
	3,  // 9: infraboard.mpaas.build.RPC.UpdateBuildConfig:input_type -> infraboard.mpaas.build.UpdateBuildConfigRequest
	4,  // 10: infraboard.mpaas.build.RPC.DeleteBuildConfig:input_type -> infraboard.mpaas.build.DeleteBuildConfigRequest
	11, // 11: infraboard.mpaas.build.RPC.CreateBuildConfig:output_type -> infraboard.mpaas.build.BuildConfig
	12, // 12: infraboard.mpaas.build.RPC.QueryBuildConfig:output_type -> infraboard.mpaas.build.BuildConfigSet
	11, // 13: infraboard.mpaas.build.RPC.DescribeBuildConfig:output_type -> infraboard.mpaas.build.BuildConfig
	11, // 14: infraboard.mpaas.build.RPC.UpdateBuildConfig:output_type -> infraboard.mpaas.build.BuildConfig
	11, // 15: infraboard.mpaas.build.RPC.DeleteBuildConfig:output_type -> infraboard.mpaas.build.BuildConfig
