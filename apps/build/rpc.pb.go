...
var file_apps_build_pb_rpc_proto_rawDesc = []byte{
	...
	0x75, 0x69, 0x6c, 0x64, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x32, 0xca, 0x02, 0x0a, 0x03, 0x52, 0x50, 0x43, 0x12,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x65, 0x74, 0x12, 0x6a, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61,
	...
	0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x75, 0x69,
	...
	0x6e, 0x66, 0x69, 0x67, 0x42, 0x28, 0x5a, 0x26, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_apps_build_pb_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_apps_build_pb_rpc_proto_goTypes = []interface{}{
	...
	(*CreateBuildConfigRequest)(nil), // 6: infraboard.mpaas.build.CreateBuildConfigRequest
	(*BuildConfig)(nil),              // 7: infraboard.mpaas.build.BuildConfig
	(*BuildConfigSet)(nil),           // 8: infraboard.mpaas.build.BuildConfigSet
}
var file_apps_build_pb_rpc_proto_depIdxs = []int32{
	...
	4, // 1: infraboard.mpaas.build.QueryBuildConfigRequest.page:type_name -> infraboard.mcube.page.PageRequest
	5, // 2: infraboard.mpaas.build.UpdateBuildConfigRequest.update_mode:type_name -> infraboard.mcube.request.UpdateMode
	6, // 3: infraboard.mpaas.build.UpdateBuildConfigRequest.spec:type_name -> infraboard.mpaas.build.CreateBuildConfigRequest
	6, // 4: infraboard.mpaas.build.RPC.CreateBuildConfig:input_type -> infraboard.mpaas.build.CreateBuildConfigRequest
	2, // 5: infraboard.mpaas.build.RPC.QueryBuildConfig:input_type -> infraboard.mpaas.build.QueryBuildConfigRequest
	3, // 6: infraboard.mpaas.build.RPC.UpdateBuildConfig:input_type -> infraboard.mpaas.build.UpdateBuildConfigRequest
	7, // 7: infraboard.mpaas.build.RPC.CreateBuildConfig:output_type -> infraboard.mpaas.build.BuildConfig
	8, // 8: infraboard.mpaas.build.RPC.QueryBuildConfig:output_type -> infraboard.mpaas.build.BuildConfigSet
	7, // 9: infraboard.mpaas.build.RPC.UpdateBuildConfig:output_type -> infraboard.mpaas.build.BuildConfig
