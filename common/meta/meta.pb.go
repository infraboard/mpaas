...
func (x *Scope) Reset() {
	*x = Scope{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_meta_meta_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Scope) Descriptor() ([]byte, []int) {
	return file_common_meta_meta_proto_rawDescGZIP(), []int{1}
}
...
var file_common_meta_meta_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1c, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62,
	0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x70, 0x61, 0x61, 0x73, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x22, 0x6d, 0x0a, 0x04, 0x4d, 0x65, 0x74, 0x61, 0x12, 0x0e,
	...
	0x61, 0x61, 0x73, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x6d, 0x65, 0x74, 0x61, 0x62,
...
var file_common_meta_meta_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_common_meta_meta_proto_goTypes = []interface{}{
	(*Meta)(nil),  // 0: infraboard.mpaas.common.meta.Meta
	(*Scope)(nil), // 1: infraboard.mpaas.common.meta.Scope
}
...
func file_common_meta_meta_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_common_meta_meta_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Scope); i {
			case 0:
				return &v.state
			case 1:
